<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: TURMERIC FINGER (WHOLE)
// ----------------------------------------------------------------
$productName  = "Turmeric Finger (Whole)";
$categoryName = "WHOLE SPICES";
$bannerText   = "RAW HALDI";
$imagePath    = "../assets/images/turmericwh.jpg"; // Updated image for Whole Turmeric
$bgImage      = "../assets/images/Web.avif";        // Same background

// SEO META DATA
$pageTitle    = "Whole Turmeric Finger Exporter India | Salem, Nizamabad, Erode Haldi | AGROX";
$pageDesc     = "Bulk exporter of premium Turmeric Fingers (Whole Haldi) from India. We supply Double Polished Salem, Nizamabad, and Erode turmeric fingers with high curcumin content.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Premium Turmeric Fingers Export Quality" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Premium Polished</h4>
                                <p>Double polished fingers for bright golden color and clean appearance.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Curcumin</h4>
                                <p>Sourced from Salem & Nizamabad, known for potent active ingredients.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Sun Dried</h4>
                                <p>Traditionally dried to reduce moisture (<10%) and prevent fungal growth.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Machine Cleaned</h4>
                                <p>Sorted to ensure uniform size, zero foreign matter, and export quality.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports premium quality Turmeric Fingers, sourced directly from the fertile lands of Erode, Salem, and Nizamabad. Our whole turmeric is celebrated for its high curcumin content, vibrant yellow color, and robust aroma. We offer both polished and unpolished varieties, carefully graded to meet international food safety standards.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Popular Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            ...
                            <ul>
                                ...
                                <li><strong>Best For:</strong> Supermarkets, Retail</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Nizamabad Finger</h4>
                            <ul>
                                <li><strong>Color:</strong> Deep Yellow</li>
                                <li><strong>Curcumin:</strong> 2.5% - 3.5%</li>
                                <li><strong>Best For:</strong> Grinding, Blending</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Erode Finger</h4>
                            <ul>
                                <li><strong>Color:</strong> Yellowish Orange</li>
                                <li><strong>Curcumin:</strong> 3% - 4%</li>
                                <li><strong>Best For:</strong> Domestic & Export</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Bulb (Gatha)</h4>
                            <ul>
                                <li><strong>Shape:</strong> Round/Bulbous</li>
                                <li><strong>Curcumin:</strong> High</li>
                                <li><strong>Best For:</strong> Powder Manufacturing</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Type</th><td>Whole Finger / Bulb</td></tr>
                        <tr><th>Curcumin</th><td>2.5% - 5%</td></tr>
                        <tr><th>Moisture</th><td>10% - 12% Max</td></tr>
                        <tr><th>Length</th><td>5cm - 8cm (Fingers)</td></tr>
                        <tr><th>Broken / Defective</th><td>3% Max</td></tr>
                        <tr><th>Foreign Matter</th><td>1% Max</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Jute / Gunny Bags:</strong> 25kg, 50kg (Traditional)<br><strong>PP Bags:</strong> 25kg, 50kg (Moisture Proof)<br>Customized marking available.</p>
                    </div>
                    <div class="info-card">
                        <h4>Storage & Shelf Life</h4>
                        <p>Stored in cool, dry warehouses. <strong>Shelf Life:</strong> 24 Months when stored properly away from direct sunlight.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 17 - 18 Metric Tons<br><strong>40 FT:</strong> 26 - 27 Metric Tons<br><strong>Lead Time:</strong> 10-15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Spice Grinding Mills</h4>
                        <p>Preferred by spice manufacturers globally for grinding into premium turmeric powder due to its high oil content and color.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Extraction & Pharma</h4>
                        <p>High-curcumin dried turmeric is the primary raw material for extracting Curcumin and Oleoresins for pharmaceutical use.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Polished and Unpolished?</span>
                        <span class="faq-a">Polished fingers are machine-cleaned to remove the rough skin for a better look. Unpolished is raw and rough but retains more oil.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply double polished turmeric?</span>
                        <span class="faq-a">Yes, we specialize in double polished Salem and Nizamabad fingers which have a premium bright yellow appearance.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you test for Lead Chromate?</span>
                        <span class="faq-a">Strictly yes. Artificial coloring is strictly prohibited. We provide lab reports confirming zero lead chromate.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the origin of your turmeric?</span>
                        <span class="faq-a">We source directly from farmers in Erode (Tamil Nadu), Nizamabad (Telangana), and Sangli (Maharashtra).</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Turmeric Fingers (Whole)",
  "image": "https://theagroxgroup.org/assets/images/turmericwh.jpg",
  "description": "Export-grade Indian Whole Turmeric Fingers from Salem and Nizamabad. High curcumin, double polished.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "TURM-WH-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/turmeric-finger-exporter-from-india.php",
    "priceCurrency": "USD",
