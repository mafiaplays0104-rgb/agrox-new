<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CLOVES (LAUNG)
// ----------------------------------------------------------------
$productName  = "Cloves (Laung)";
$categoryName = "WHOLE SPICES";
$bannerText   = "SYZYGIUM AROMATICUM"; // Scientific/Trade name
$imagePath    = "../assets/images/clove.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Cloves (Laung) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy premium Cloves (Laung) in bulk. We export Hand-Picked (Lal Pari) and FAQ grades. Rich in Eugenol oil, bold size, and intensely aromatic.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Cloves Laung Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich in Eugenol</h4>
                                <p>Contains high levels of Eugenol (essential oil), providing intense aroma and medicinal value.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Premium "Lal Pari"</h4>
                                <p>We specialize in the "Lal Pari" grade (Reddish-Brown), known for its superior size and oil content.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Hand-Picked Purity</h4>
                                <p>Harvested manually to ensure full flower heads and stems are intact, minimizing headless cloves.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Deep Origin</h4>
                                <p>Sourced from the spice-rich hills of Kerala (Idukki) and Kanyakumari, India.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports high-quality Cloves (Laung), cherished globally for their pungent, warm flavor and powerful medicinal properties. Sourced from the best plantations in Southern India, our cloves are carefully dried to a reddish-brown color, ensuring the retention of volatile oils. We offer premium Hand-Picked Selected (HPS) grades that guarantee bold size and minimal headless content.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Hand Picked (Lal Pari)</h4>
                            <ul>
                                <li><strong>Quality:</strong> Premium / Bold.</li>
                                <li><strong>Appearance:</strong> Reddish-Brown, full head.</li>
                                <li><strong>Use:</strong> Retail Packs, Gourmet Cooking.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>FAQ (Fair Average)</h4>
                            <ul>
                                <li><strong>Quality:</strong> Standard mixed size.</li>
                                <li><strong>Appearance:</strong> Dark Brown / Blackish.</li>
                                <li><strong>Use:</strong> Grinding (Masala), Oil Extraction.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Headless Cloves</h4>
                            <ul>
                                <li><strong>Quality:</strong> Economical.</li>
                                <li><strong>Feature:</strong> Missing flower bud (head).</li>
                                <li><strong>Use:</strong> Industrial Flavoring, Powder.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Clove Stems</h4>
                            <ul>
                                <li><strong>Part:</strong> Stem of the flower bud.</li>
                                <li><strong>Oil Content:</strong> High (for extraction).</li>
                                <li><strong>Use:</strong> Distillation (Clove Oil).</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Syzygium aromaticum</td></tr>
                        <tr><th>Moisture</th><td>12% Maximum</td></tr>
                        <tr><th>Headless Cloves</th><td>Max 2% (Premium Grade)</td></tr>
                        <tr><th>Extraneous Matter</th><td>0.5% Maximum</td></tr>
                        <tr><th>Volatile Oil</th><td>Min 18% - 20%</td></tr>
                        <tr><th>Color</th><td>Reddish Brown to Dark Brown</td></tr>
                        <tr><th>Origin</th><td>India / Madagascar / Sri Lanka</td></tr>
                        <tr><th>Packaging</th><td>10kg / 25kg Jute or Carton</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Moisture Barrier</strong><br>Packed in 25kg or 50kg Jute bags with inner poly lining or 10kg Cartons to prevent moisture absorption and oil loss.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Spice Blends</strong><br>A key component of Garam Masala, Chai Masala, pumpkin spice blends, and used whole in biryanis and stews.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 10-12 Metric Tons<br><strong>Availability:</strong> Year-round<br><strong>Storage:</strong> Cool, Dry Place</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is "Lal Pari" quality?</span>
                        <span class="faq-a">"Lal Pari" refers to the premium grade of cloves that have a distinct reddish-brown hue, indicating superior drying and high oil content compared to black cloves.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the oil content in your cloves?</span>
                        <span class="faq-a">Our premium Indian cloves typically have a volatile oil content ranging from 18% to 21%, making them highly potent.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you sell Clove Stems?</span>
                        <span class="faq-a">Yes, we supply Clove Stems separately for clients involved in essential oil distillation, as stems are a cost-effective source of eugenol.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you prevent mold during shipping?</span>
                        <span class="faq-a">We ensure the cloves are dried to below 12% moisture before packing and use high-quality liners to prevent humidity ingress during transit.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Cloves (Laung)",
  "image": "https://theagroxgroup.org/assets/images/clove.avif",
  "description": "Premium Cloves (Laung) Exporter from India. Available in Hand-Picked Lal Pari and FAQ grades. High oil content.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CLOVE-HP-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/cloves-exporter-from-india.php",
    "priceCurrency": "USD",
