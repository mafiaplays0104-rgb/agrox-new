<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: ALMONDS (BADAM)
// ----------------------------------------------------------------
$productName  = "Almonds (Badam)";
$categoryName = "DRY FRUITS & NUTS";
$bannerText   = "ALMOND"; // Trade name
$imagePath    = "../assets/images/almonds.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Almonds (Badam) Importer & Exporter India | AGROX";
$pageDesc     = "Buy premium Almond Kernels in bulk. We supply California Nonpareil, Mamra, and Gurbandi varieties. 100% natural, sweet, and graded for size (18/20 to 27/30).";
...
<div class="banner-wrapper">
    ...
    <h1 class="banner-title" id="fgText"><?php echo $categoryName; ?></h1> <div class="vignette-overlay"></div>
</div>
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Almonds Badam Kernels Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Brain Food</h4>
                                <p>Rich in Vitamin E and antioxidants, known to support memory and cognitive health.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Available in Nonpareil, Carmel, and Mamra varieties, strictly graded by kernel count per ounce.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Natural</h4>
                                <p>Raw, unpasteurized options available (Mamra) or pasteurized (California) for safety.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Origin Guarantee</h4>
                                <p>We supply top-grade California Almonds and authentic Kashmiri/Irani Mamra Almonds.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX offers a diverse range of premium Almonds (Badam), catering to both confectionery industries and health-conscious consumers. From the popular California Nonpareil known for its uniform shape and sweet taste, to the exotic Mamra Badam prized for its high oil content and potency, our almonds are stored in temperature-controlled environments to maintain their crunch and freshness.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>California Nonpareil</h4>
                            <ul>
                                <li><strong>Texture:</strong> Soft shell, smooth skin.</li>
                                <li><strong>Taste:</strong> Sweet, uniform size.</li>
                                <li><strong>Use:</strong> Snacking, Blanching, Milk.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Mamra Badam (Premium)</h4>
                            <ul>
                                <li><strong>Shape:</strong> Concave (curved).</li>
                                <li><strong>Features:</strong> High oil content, potent.</li>
                                <li><strong>Origin:</strong> Iran / Kashmir.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Gurbandi (Choti Giri)</h4>
                            <ul>
                                <li><strong>Taste:</strong> Slightly bitter-sweet.</li>
                                <li><strong>Oil Content:</strong> Very high.</li>
                                <li><strong>Use:</strong> Medicinal, Ayurvedic.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>California Carmel/Sanora</h4>
                            <ul>
                                <li><strong>Shape:</strong> Smaller, slightly wrinkled.</li>
                                <li><strong>Use:</strong> Roasting, Baking, Ingredients.</li>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Prunus dulcis</td></tr>
                        <tr><th>Moisture</th><td>5% - 6% Maximum</td></tr>
                        <tr><th>Count per Ounce</th><td>18/20, 20/22, 23/25, 27/30</td></tr>
                        <tr><th>Admixture</th><td>1% Maximum</td></tr>
                        <tr><th>Broken Kernels</th><td>Max 5%</td></tr>
                        <tr><th>Flavor</th><td>Characteristic, Sweet</td></tr>
                        <tr><th>Packaging</th><td>22.68kg (50lbs) Cartons / 10kg Vacuum</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Vacuum & Cartons</strong><br>Standard packing is 50lbs (22.68kg) cardboard cartons. High-value varieties like Mamra are vacuum packed in 5kg/10kg blocks.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Versatile Ingredient</strong><br>Used for almond flour, milk (vegan dairy alternative), butter, roasting, and traditional Indian sweets like Badam Halwa.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> Approx. 18 Metric Tons<br><strong>Storage:</strong> Cool Dry Place (0-10°C)<br><strong>Availability:</strong> Year-round</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Mamra and California almonds?</span>
                        <span class="faq-a">California almonds are larger, sweeter, and mass-produced. Mamra almonds are concave, contain more natural oil, and are considered nutritionally superior.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What does "23/25" mean in grading?</span>
                        <span class="faq-a">This refers to the number of whole almond kernels per ounce. Lower numbers (18/20) mean larger almonds; higher numbers (27/30) mean smaller almonds.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Are your almonds pasteurized?</span>
                        <span class="faq-a">Yes, our California almonds are steam pasteurized as per USDA regulations. Mamra and Gurbandi varieties are typically raw.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you sell broken almonds?</span>
                        <span class="faq-a">Yes, we supply broken almond grades (splits/pieces) which are cost-effective for bakeries and flour manufacturing.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Almonds (Badam)",
  "image": "https://theagroxgroup.org/assets/images/almonds.avif",
  "description": "Premium Almond Kernels Exporter from India. Varieties include California Nonpareil, Mamra, and Gurbandi. Graded by count per ounce.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "ALMOND-KER-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/almonds-exporter-from-india.php",
    "priceCurrency": "USD",
