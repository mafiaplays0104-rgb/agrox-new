<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: GINGER POWDER
// ----------------------------------------------------------------
$productName  = "Ginger Powder (Sonth)";
$categoryName = "POWDERED SPICES";
$bannerText   = "ZESTY";
$imagePath    = "../assets/images/gingerpw.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Dry Ginger Powder (Sonth) Exporter India | Premium Cochin & Shimoga Quality | AGROX";
$pageDesc     = "Leading exporter of Dry Ginger Powder (Sonth) from India. We supply premium Cochin and Shimoga ginger powder, known for high gingerol content and zesty aroma.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Ginger Powder Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Premium Cochin</h4>
                                <p>Sourced from Kerala, famous for low fiber and high volatile oil content.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Gingerol</h4>
                                <p>Potent bioactive compound for strong flavor and health benefits.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Fiber Free</h4>
                                <p>Processed to remove tough fibers, ensuring a smooth, fine powder.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>No Additives</h4>
                                <p>100% natural dried ginger (Sonth) without bleaching agents.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you high-grade Dry Ginger Powder (Sonth), derived from the finest ginger rhizomes grown in Kerala and Karnataka. Our ginger is washed, peeled, sun-dried, and ground at low temperatures to preserve its zesty aroma and sharp flavor. It is a staple spice for baking, masala blends, and medicinal tea mixes due to its digestive properties.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Cochin Quality</h4>
                            <ul>
                                <li><strong>Features:</strong> Light color, Low fiber</li>
                                <li><strong>Aroma:</strong> Lemon-like & Spicy</li>
                                <li><strong>Use:</strong> Premium Baking, Exports</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Shimoga Quality</h4>
                            <ul>
                                <li><strong>Features:</strong> Bold flavor</li>
                                <li><strong>Aroma:</strong> Strong & Pungent</li>
                                <li><strong>Use:</strong> Curry Powders, Masalas</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Calicut Quality</h4>
                            <ul>
                                <li><strong>Features:</strong> High Oil Content</li>
                                <li><strong>Color:</strong> Darker Brown</li>
                                <li><strong>Use:</strong> Oleoresin Extraction</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Organic Grade</h4>
                            <ul>
                                <li><strong>Features:</strong> Certified Organic</li>
                                <li><strong>Purity:</strong> 100% Chemical Free</li>
                                <li><strong>Use:</strong> Health Supplements</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Volatile Oil</th><td>1.5% Min</td></tr>
                        <tr><th>Moisture</th><td>10% Max</td></tr>
                        <tr><th>Total Ash</th><td>8% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>1% Max</td></tr>
                        <tr><th>Calcium (as CaO)</th><td>1.1% Max</td></tr>
                        <tr><th>Alcohol Soluble Ext.</th><td>4.5% Min</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>HDPE or Paper Bags with inner poly liner to prevent moisture absorption and caking.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Jars</strong><br>100g, 200g laminated pouches for retail brands. Private labeling services available.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 14 - 15 Metric Tons<br><strong>40 FT:</strong> 26 - 27 Metric Tons<br><strong>Lead Time:</strong> 15-20 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Bakery & Confectionery</h4>
                        <p>Essential for Gingerbread cookies, cakes, biscuits, and candies for a warm, spicy kick.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Pharmaceuticals</h4>
                        <p>Used in cough syrups, digestive aids, and immunity boosters due to its anti-inflammatory properties.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your ginger powder bleached?</span>
                        <span class="faq-a">No, we supply unbleached ginger powder. However, we can provide limed (bleached) ginger upon specific buyer request.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the gingerol content?</span>
                        <span class="faq-a">Our premium Cochin grade has a high gingerol content, typically between 1.5% to 2.5%.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Does it contain SO2?</span>
                        <span class="faq-a">Our standard product is free from Sulphur Dioxide (SO2). We strictly adhere to EU regulations.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply Ginger Slice/Flakes?</span>
                        <span class="faq-a">Yes, we also export Dried Ginger Slices (Whole) for extraction and grinding purposes.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/gingerpw.avif",
  "description": "Export-grade Indian Dry Ginger Powder. Premium Cochin quality, high gingerol, no additives.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "GIN-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/ginger-powder-exporter-from-india.php",
    "priceCurrency": "USD",
