<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: RAISINS (KISHMISH)
// ----------------------------------------------------------------
$productName  = "Raisins (Kishmish)";
$categoryName = "DRY FRUITS & NUTS";
$bannerText   = "DRIED GRAPES"; // Trade name
$imagePath    = "../assets/images/raisin.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Raisins (Kishmish) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy premium Raisins (Kishmish) in bulk. We supply Golden, Malayar, and Black varieties. Sourced from Nashik, washed, and laser sorted.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Raisins Kishmish Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Nashik Origin</h4>
                                <p>Sourced from the lush vineyards of Nashik and Sangli, famous for sweet, high-Brix grapes.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Laser Sorted</h4>
                                <p>Cleaned and sorted using advanced laser technology to ensure uniform size and color.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sun-dried to concentrate natural sugars. No added sugar or artificial sweeteners.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Wide Variety</h4>
                                <p>Available in Golden, Malayar (Brown), Black, and Green varieties to suit every market.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the finest Raisins (Kishmish) from the heart of India's grape country. Produced by drying superior quality seedless grapes, our raisins are known for their plump texture and intense sweetness. They are meticulously washed, stemmed, and graded to ensure they are ready for direct consumption or industrial use in bakeries and confectioneries.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Golden Raisins</h4>
                            <ul>
                                <li><strong>Process:</strong> Sulfur treated for color.</li>
                                <li><strong>Appearance:</strong> Bright Golden Yellow.</li>
                        ...
                        <div class="variety-card">
                            <h4>Malayar (Brown)</h4>
                            <ul>
                                <li><strong>Process:</strong> Naturally dried (with dipping oil).</li>
                                <li><strong>Appearance:</strong> Light to Dark Brown.</li>
                                <li><strong>Use:</strong> Bakery, Wholesale staple.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Black Raisins (Kali Draksh)</h4>
                            <ul>
                                <li><strong>Type:</strong> Seedless / With Seed.</li>
                                <li><strong>Taste:</strong> Sweet & Tangy.</li>
                                <li><strong>Use:</strong> Medicinal, Ayurveda.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Green Raisins</h4>
                            <ul>
                                <li><strong>Process:</strong> Shade dried.</li>
                                <li><strong>Appearance:</strong> Long, Green.</li>
                                <li><strong>Use:</strong> Mouth freshener, Snacks.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Vitis vinifera</td></tr>
                        <tr><th>Moisture</th><td>13% - 15% Maximum</td></tr>
                        <tr><th>Size</th><td>Small / Medium / Bold / Jumbo</td></tr>
                        <tr><th>Admixture</th><td>0.5% Maximum</td></tr>
                        <tr><th>Berry Count</th><td>300-500 berries per 100g</td></tr>
                        <tr><th>Origin</th><td>Nashik / Sangli (India)</td></tr>
                        <tr><th>Packaging</th><td>10kg / 15kg Cartons</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Bulk Cartons</strong><br>We pack in 10kg or 15kg corrugated boxes with a food-grade poly liner inside to maintain moisture balance.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Baking & Cooking</strong><br>Essential for fruit cakes, cookies, traditional rice dishes (Biryani/Pulao), and trail mixes.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 18-19 Metric Tons<br><strong>Storage:</strong> Cool Dry Place (Below 10°C)<br><strong>Availability:</strong> Year-round</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Golden and Malayar?</span>
                        <span class="faq-a">Golden raisins are treated with sulfur dioxide to preserve their light color. Malayar raisins are dipped in oil and dried, resulting in a natural brown color.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you supply seedless raisins?</span>
                        <span class="faq-a">Yes, the majority of our export volume (Golden, Malayar, Green) is produced from seedless Thompson Seedless grapes.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Are your raisins washed?</span>
                        <span class="faq-a">Yes, all our raisins undergo a thorough washing, stemming, and cleaning process before being laser sorted and packed.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the berry count?</span>
                        <span class="faq-a">Berry count refers to the number of raisins in 100 grams. Standard counts range from 300-500 (Medium) to <250 (Jumbo).</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/raisin.avif",
  "description": "Premium Raisins (Kishmish) Exporter from India. Varieties include Golden, Malayar, and Black. Sourced from Nashik, laser sorted.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "RAISIN-GLD-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/raisins-exporter-from-india.php",
    "priceCurrency": "USD",
