<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CORIANDER SEEDS
// ----------------------------------------------------------------
$productName  = "Coriander Seeds (Dhania)";
$categoryName = "WHOLE SPICES";
$bannerText   = "AROMATIC";
$imagePath    = "../assets/images/corianderwh.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Coriander Seeds Exporter India | Eagle & Scooter Grade | AGROX";
$pageDesc     = "Exporting premium Indian Coriander Seeds (Dhania). We supply Eagle, Scooter, and Parrot Green grades. Machine cleaned, high essential oil content, and aromatic.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Premium Coriander Seeds Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>High Linalool content ensures a potent citrusy and floral aroma.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Eagle Grade</h4>
                                <p>We supply the highly sought-after Eagle and Scooter varieties.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Vibrant Green</h4>
                                <p>Sourced from Rajasthan, known for seeds with a natural greenish hue.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Double cleaned to remove stems and dust, ensuring 99% purity.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports high-quality Coriander Seeds (Dhania), a cornerstone spice in global cuisines. Sourced directly from the rich soils of Rajasthan and Gujarat, our seeds are celebrated for their distinct lemony, floral flavor and high essential oil content. We offer various grades, from the premium Parrot Green to the standard Eagle variety, ensuring we meet diverse culinary and industrial needs.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Eagle Grade</h4>
                            <ul>
                                <li><strong>Color:</strong> Light Brown/Gold</li>
                                <li><strong>Purity:</strong> 99% Clean</li>
                                <li><strong>Use:</strong> General Grinding, Masalas</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Scooter Grade</h4>
                            <ul>
                                ...
                                <li><strong>Aroma:</strong> Medium to Strong</li>
                                <li><strong>Use:</strong> Middle East Export</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Parrot Green</h4>
                            <ul>
                                ...
                                <li><strong>Use:</strong> Whole Spice Retail</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Split (Dhania Dal)</h4>
                            <ul>
                                <li><strong>Form:</strong> Split Kernels</li>
                                <li><strong>Usage:</strong> Mouth Freshener</li>
                                <li><strong>Flavor:</strong> Salty/Roasted options</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Purity</th><td>98% - 99%</td></tr>
                        <tr><th>Moisture</th><td>9% - 10% Max</td></tr>
                        <tr><th>Total Ash</th><td>7% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>1.5% Max</td></tr>
                        <tr><th>Volatile Oil</th><td>0.3% - 1%</td></tr>
                        <tr><th>Split Seeds</th><td>5% Max (For Whole Grades)</td></tr>
                        <tr><th>Salmonella</th><td>Absent / 25g</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 40kg / 50kg</strong><br>PP Woven Bags or Jute Gunny Bags. Jute is preferred for breathability in certain climates.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches</strong><br>100g to 1kg laminated pouches. Nitrogen flushed to maintain the green color and aroma.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 9 - 10 Metric Tons (Light weight)<br><strong>40 FT:</strong> 23 - 24 Metric Tons<br><strong>Lead Time:</strong> 15-20 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        ...
                        <p>The primary base ingredient for almost all Curry Powders and Garam Masala blends worldwide.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Oil Distilleries</h4>
                        <p>Used to extract Coriander Essential Oil, widely used in perfumes, cosmetics, and liqueurs.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What causes the green color?</span>
                        <span class="faq-a">Harvesting at the right maturity stage and proper shade drying helps retain the chlorophyll, giving it a premium green look.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer split coriander?</span>
                        <span class="faq-a">Yes, we supply Dhania Dal (Split Coriander), both raw and roasted, often used as a mouth freshener (Mukhwas).</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it Machine Cleaned?</span>
                        <span class="faq-a">Yes, all our export cargoes are Machine Cleaned and Sortexed to ensure uniformity and remove stalks/dust.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you ship mixed containers?</span>
                        <span class="faq-a">Absolutely. Coriander is light, so mixing it with heavy spices like Cumin or Fenugreek helps optimize container weight.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/corianderwh.jpg",
  "description": "Export-grade Indian Coriander Seeds. Eagle and Scooter grades available. Rich aroma, machine cleaned.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "COR-SD-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/coriander-seeds-exporter-from-india.php",
    "priceCurrency": "USD",
