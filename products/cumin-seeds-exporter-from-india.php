<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CUMIN SEEDS
// ----------------------------------------------------------------
$productName  = "Cumin Seeds (Jeera)";
$categoryName = "WHOLE SPICES";
$bannerText   = "AROMATIC";
$imagePath    = "../assets/images/cuminwh.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Cumin Seeds (Jeera) Exporter India | Singapore & Europe Quality | AGROX";
$pageDesc     = "Leading exporter of Cumin Seeds (Jeera) from Unjha, Gujarat. We supply 99% and 99.5% purity Machine Cleaned and Sortex Cumin Seeds worldwide.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Premium Cumin Seeds Export Quality" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich Aroma</h4>
                                <p>High volatile oil content ensures a strong, earthy fragrance distinctive to Indian cumin.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Machine cleaned and color sorted to remove stems, dust, and foreign matter.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Origin Gujarat</h4>
                                <p>Sourced from Unjha, Gujarat – the world's largest market for Cumin seeds.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>99.5% Purity</h4>
                                <p>We offer Singapore Quality (99%) and Europe Quality (99.5%) for export.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the finest quality Cumin Seeds (Jeera), a quintessential spice in global cuisines. Sourced directly from the sun-drenched fields of Gujarat and Rajasthan, our cumin is renowned for its bold size, intense aroma, and rich essential oil content. We process our seeds in hygienic facilities to ensure 99% to 99.5% purity, making them ideal for international markets.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Export Quality Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Singapore Quality</h4>
                            <ul>
                                <li><strong>Purity:</strong> 99% Pure</li>
                                <li><strong>Admixture:</strong> 1% Max</li>
                                <li><strong>Best For:</strong> Asian Markets, Grinding</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Europe Quality</h4>
                            <ul>
                                <li><strong>Purity:</strong> 99.5% Pure</li>
                                <li><strong>Admixture:</strong> 0.5% Max</li>
                                <li><strong>Best For:</strong> EU, USA, High-end Retail</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Gulf Quality</h4>
                            <ul>
                                ...
                                <li><strong>Appearance:</strong> Bold & Brown</li>
                                <li><strong>Best For:</strong> Middle East Markets</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Grinding Quality</h4>
                            <ul>
                                <li><strong>Purity:</strong> Standard</li>
                                <li><strong>Oil Content:</strong> High</li>
                                <li><strong>Best For:</strong> Powder Manufacturers</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Cuminum Cyminum</td></tr>
                        <tr><th>Purity</th><td>99% / 99.5% / 98%</td></tr>
                        <tr><th>Moisture</th><td>8% - 9% Max</td></tr>
                        <tr><th>Admixture</th><td>1% Max / 0.5% Max</td></tr>
                        <tr><th>Volatile Oil</th><td>2.5% Min</td></tr>
                        <tr><th>Salmonella / E.Coli</th><td>Absent</td></tr>
                        <tr><th>Origin</th><td>Gujarat / Rajasthan, India</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>PP Bags:</strong> 25kg, 50kg (Standard)<br><strong>Jute Bags:</strong> 25kg, 50kg (Eco-friendly)<br><strong>Paper Bags:</strong> 25kg (Multi-wall)</p>
                    </div>
                    <div class="info-card">
                        <h4>Private Label</h4>
                        <p>We provide white-label services for retail brands. Customized pouches (500g, 1kg) available with your branding and barcodes.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 13 - 14 Metric Tons<br><strong>40 FT:</strong> 26 - 27 Metric Tons<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Food & Spices</h4>
                        <p>Used universally in curry powders, taco seasonings, breads, and cheeses for its distinct warm flavor.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Essential Oils</h4>
                        <p>High oil content cumin is distilled to produce Cumin Essential Oil, used in perfumes and flavorings.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Singapore and Europe quality?</span>
                        <span class="faq-a">Singapore quality allows up to 1% admixture, while Europe quality is stricter with max 0.5% admixture and follows EU pesticide norms.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Where is your Cumin sourced from?</span>
                        <span class="faq-a">We source primarily from Unjha, Gujarat, which is known as the "Cumin City" of the world.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer IPM Cumin?</span>
                        <span class="faq-a">Yes, we offer IPM (Integrated Pest Management) Cumin which uses minimal biological pesticides, suitable for sensitive markets.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you ship mixed containers?</span>
                        <span class="faq-a">Yes, we can consolidate Cumin with Coriander, Fennel, and Fenugreek seeds in a single FCL shipment.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/cuminwh.avif",
  "description": "Export-grade Indian Cumin Seeds (Jeera). 99% and 99.5% Purity, Machine Cleaned and Sortex Quality from Gujarat.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CUM-SD-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/cumin-seeds-exporter-from-india.php",
    "priceCurrency": "USD",
