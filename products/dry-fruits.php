<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: DRY FRUITS
// ----------------------------------------------------------------
$pageTitle = "Dry Fruits Exporter India | Premium Cashews, Almonds, Walnuts & Dates";
$metaDescription = "Exporting premium quality Dry Fruits & Nuts. AGROX offers bulk supplies of W240 Cashews, California Almonds, Kashmiri Walnuts, and Fox Nuts (Makhana).";
$canonicalURL = "https://www.theagroxgroup.com/dry-fruits.php";
...
<div class="banner-wrapper">
    <img src="../assets/images/bannerproduct.avif" alt="Dry Fruits Banner" class="banner-img-responsive">
    <div class="banner-scroll-text" id="bgText">DRY FRUITS</div>
    <h1 class="banner-title" id="fgText">DRY FRUITS</h1> 
    ...
    <div class="wide-display-area">
        <div class="glass-panel">
            ...
            <div class="category-intro">
                <span class="cat-subtitle">NATURE'S CANDY</span>
                <h2 class="cat-main-title">Dry Fruits & Nuts</h2>
                <p class="cat-desc">
                    Experience the crunch of health with AGROX's premium collection of Dry Fruits and Nuts. Sourced from the best orchards globally and processed to retain maximum nutrition, our range is perfect for wholesome snacking and culinary delights.
                </p>
            </div>

            <div class="grid-4">
                
                <a href="cashew-nuts-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">W240</div>
                    <div class="harvest-img-box"><img src="../assets/images/cashew.avif" alt="Cashew Nuts Kaju" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">KAJU</span>
                        <h3>Cashew Nuts</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="makhana-exporter-from-india.php" class="harvest-card" style="transition-delay: 0.1s;">
                    <div class="harvest-badge">FOX NUTS</div>
                    <div class="harvest-img-box"><img src="../assets/images/makhana.avif" alt="Makhana Fox Nuts" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">PHOOL</span>
                        <h3>Makhana</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="dates-exporter-from-india.php" class="harvest-card" style="transition-delay: 0.2s;">
                    <div class="harvest-badge">MEDJOOL</div>
                    <div class="harvest-img-box"><img src="../assets/images/dates.avif" alt="Dates Khajoor" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">KHAJOOR</span>
                        <h3>Dates</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="almonds-exporter-from-india.php" class="harvest-card" style="transition-delay: 0.3s;">
                    <div class="harvest-badge">CALIFORNIA</div>
                    <div class="harvest-img-box"><img src="../assets/images/almonds.avif" alt="Almonds Badam" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">BADAM</span>
                        <h3>Almonds</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="pistachio-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">IRANIAN</div>
                    <div class="harvest-img-box"><img src="../assets/images/pistachio.avif" alt="Pistachio Pista" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">PISTA</span>
                        <h3>Pistachio</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="walnuts-exporter-from-india.php" class="harvest-card" style="transition-delay: 0.1s;">
                    <div class="harvest-badge">KASHMIRI</div>
                    <div class="harvest-img-box"><img src="../assets/images/walnut.avif" alt="Walnuts Akhrot" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">AKHROT</span>
                        <h3>Walnut</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="figs-exporter-from-india.php" class="harvest-card" style="transition-delay: 0.2s;">
                    <div class="harvest-badge">DRIED</div>
                    <div class="harvest-img-box"><img src="../assets/images/figs.avif" alt="Dried Figs Anjeer" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">ANJEER</span>
                        <h3>Figs</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="raisins-exporter-from-india.php" class="harvest-card" style="transition-delay: 0.3s;">
                    <div class="harvest-badge">GOLDEN</div>
                    <div class="harvest-img-box"><img src="../assets/images/raisin.avif" alt="Raisins Kishmish" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">KISHMISH</span>
                        <h3>Raisins</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>
            ...
            <div class="marquee-section">
                <div class="marquee-content">
                    <span class="marquee-text">PREMIUM DRY FRUITS • HEALTHY SNACKING • AGROX GLOBAL EXPORTS •</span>
                    <span class="marquee-text">PREMIUM DRY FRUITS • HEALTHY SNACKING • AGROX GLOBAL EXPORTS •</span>
                </div>
            </div>
            ...
            <div class="cine-section">
                <div class="cine-container">
                    ...
                    <div class="cine-sticky-col">
                        ...
                        <h2 class="cine-big-title">THE GLOBAL<br>STANDARD FOR<br><span class="cine-gold">PREMIUM NUTS</span></h2>
                        
                        <div class="stats-container">
                            <div class="stat-box">
                                <span class="stat-value">W240</span>
                    ...
                    <div class="cine-scroll-col">
                        ...
                        <div class="text-reveal-mask">
                            <p class="cine-text">
                                Dry fruits are nature's powerhouse of nutrition. At AGROX, we understand that quality is defined by size, texture, and freshness. We export only the finest selection, from creamy <strong>Cashews (W240/W320)</strong> processed in state-of-the-art facilities to premium <strong>California Almonds</strong> and Kashmiri Walnuts.
                            </p>
                        </div>

                        <div class="text-reveal-mask">
                            <p class="cine-text">
                                Our procurement network spans the best orchards, ensuring consistent supply year-round. Whether it's <strong>Makhana (Fox Nuts)</strong> for healthy snacking or <strong>Dates</strong> for natural sweetness, every batch is graded for uniformity and packed to preserve its natural crunch and oil content.
                            </p>
                        </div>
                        ...
                        <div class="features-grid">
                            ...
                            <div class="feature-card">
                                <i class="fas fa-sort-amount-up f-icon"></i>
                                <h4 class="f-title">Precision Grading</h4>
                                <p class="f-desc">Laser-sorted nuts ensuring uniform size and zero broken pieces, meeting global export specifications.</p>
                            </div>

                            <div class="feature-card">
                                <i class="fas fa-box-open f-icon"></i>
                                <h4 class="f-title">Vacuum Packing</h4>
                                <p class="f-desc">Advanced nitrogen flushing and vacuum packing to prevent oxidation and maintain freshness during transit.</p>
                            </div>

                            <div class="feature-card">
                                <i class="fas fa-seedling f-icon"></i>
                                <h4 class="f-title">Origin Traceability</h4>
                                <p class="f-desc">We provide full traceability from the farm level, ensuring ethical sourcing and authenticity of origin.</p>
                            </div>

                            <div class="feature-card">
                                <i class="fas fa-truck-loading f-icon"></i>
                                <h4 class="f-title">Custom Packaging</h4>
                                <p class="f-desc">Available in bulk tins, cartons, or retail-ready consumer packs branded with your label.</p>
                            </div>
                ...
                <div class="cine-container" style="flex-direction: column; gap: 30px;">
                     ...
                     <div class="process-wrapper">
                         <div class="process-step">
                             ...
                             <h4 class="process-title">Harvesting</h4>
                             <p class="process-desc">Nuts are harvested at peak maturity to ensure maximum oil content and optimal flavor profile.</p>
                         </div>
                         <div class="process-step">
                             <div class="process-step-num">02</div>
                             <h4 class="process-title">Shelling & Drying</h4>
                             <p class="process-desc">Careful mechanical shelling followed by controlled drying to reduce moisture to safe storage levels.</p>
                         </div>
                         <div class="process-step">
                             <div class="process-step-num">03</div>
                             <h4 class="process-title">Optical Sorting</h4>
                             <p class="process-desc">High-tech color sorters remove discolored kernels and foreign matter, ensuring 99.9% purity.</p>
                         </div>
                         <div class="process-step">
                             <div class="process-step-num">04</div>
                             <h4 class="process-title">Quality Assurance</h4>
                             <p class="process-desc">Final manual inspection and lab testing for aflatoxins before vacuum sealing for export.</p>
                         </div>
                     </div>
                </div>
            </div>
            ...
            <section class="final-content">
                <div class="final-max-width">
                    ...
                    <p class="cine-text" style="transform: none; opacity: 1; margin-bottom: 40px; color: #ccc;">
                        Partner with AGROX for premium dry fruits that elevate your brand. We deliver health, taste, and trust in every package.
                    </p>
