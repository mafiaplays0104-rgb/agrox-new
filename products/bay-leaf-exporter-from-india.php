<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: BAY LEAF
// ----------------------------------------------------------------
$productName  = "Bay Leaf (Tej Patta)";
$categoryName = "WHOLE SPICES";
$bannerText   = "FRAGRANT";
$imagePath    = "../assets/images/bayleaf.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Bay Leaf (Tej Patta) Exporter India | Premium Hand Selected | AGROX";
$pageDesc     = "Exporting premium Indian Bay Leaves (Tej Patta). Hand-picked, mature leaves with rich aroma and olive green color. Machine cleaned and packed for global markets.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Premium Indian Bay Leaf Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Hand Selected</h4>
                                <p>Carefully hand-picked to ensure only mature, whole, unbroken leaves.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich Aroma</h4>
                                <p>Authentic 'Tej Patta' with distinct cinnamon and clove notes.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Olive Green</h4>
                                <p>Naturally dried in shade to retain the essential oils and natural green color.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Thoroughly cleaned to ensure zero dust, stalks, or foreign matter.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports finest quality Indian Bay Leaves (Tej Patta), a culinary staple prized for its complex fragrance resembling cinnamon and cloves. Sourced from the cool, hilly regions of North East and South India, our leaves are distinguished by their three-vein structure and rich essential oil content. They are meticulously dried and packed to preserve their aroma for Biryanis, soups, and curries.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Indian Bay Leaf</h4>
                            <ul>
                                <li><strong>Botanical:</strong> Cinnamomum tamala</li>
                                <li><strong>Aroma:</strong> Sweet, Cinnamon-like</li>
                                <li><strong>Appearance:</strong> 3 distinct veins</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Premium Grade</h4>
                            <ul>
                                <li><strong>Size:</strong> Large, Whole Leaves</li>
                                <li><strong>Color:</strong> Olive Green</li>
                                <li><strong>Breakage:</strong> &lt; 5%</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Standard Grade</h4>
                            <ul>
                                <li><strong>Size:</strong> Mixed Sizes</li>
                                <li><strong>Color:</strong> Greenish Brown</li>
                                <li><strong>Use:</strong> Grinding / Masala</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Machine Cleaned</h4>
                            <ul>
                                <li><strong>Process:</strong> Air Cleaned</li>
                                <li><strong>Purity:</strong> 99% Clean</li>
                                <li><strong>Use:</strong> Export Retail Packs</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Type</th><td>Whole Leaf (Tej Patta)</td></tr>
                        <tr><th>Color</th><td>Natural Olive Green</td></tr>
                        <tr><th>Moisture</th><td>13% Max</td></tr>
                        <tr><th>Volatile Oil</th><td>1% Min</td></tr>
                        <tr><th>Total Ash</th><td>4% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>0.8% Max</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>10kg / 20kg / 25kg</strong><br>Pressed Bales (to save volume) or Loose in Carton Boxes/Gunny Bags.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Packets</strong><br>50g, 100g clear pouches or branded packets. Whole leaves are delicate and packed with care.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 6 - 7 Metric Tons (Voluminous)<br><strong>40 FT:</strong> 14 - 15 Metric Tons<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Rice & Grain Industry</h4>
                        <p>Essential for packaging with premium Basmati Rice and Biryani kits to infuse aroma.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Spice Blends</h4>
                        <p>A key ingredient in Garam Masala and various curry powders, contributing a subtle sweetness.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Is this Laurel Leaf or Indian Bay Leaf?</span>
                        <span class="faq-a">We supply Indian Bay Leaf (Tej Patta/Cinnamomum tamala), which has a stronger, cinnamon-like aroma compared to Mediterranean Laurel.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you prevent breakage?</span>
                        <span class="faq-a">We use strong corrugated boxes for premium grades and avoid over-compressing unless "pressed bales" are specifically requested.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">Approx. 2 years if stored in a cool, dry place away from direct sunlight and moisture.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you provide sterilized leaves?</span>
                        <span class="faq-a">Yes, we can offer steam-sterilized bay leaves to meet strict microbiological standards for US/EU markets.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/bayleaf.avif",
  "description": "Export-grade Indian Bay Leaves (Tej Patta). Hand selected, aromatic, machine cleaned quality.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "BAY-LF-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/bay-leaf-exporter-from-india.php",
    "priceCurrency": "USD",
