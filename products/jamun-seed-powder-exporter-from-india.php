<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: JAMUN SEED POWDER
// ----------------------------------------------------------------
$productName  = "Jamun Seed Powder";
$categoryName = "HERBAL POWDERS";
$bannerText   = "DIABETIC";
$imagePath    = "../assets/images/jamunpw.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Jamun Seed Powder Exporter India | Natural Diabetes Care | AGROX";
$pageDesc     = "Exporting 100% Pure Jamun Seed Powder (Indian Blackberry). High Jamboline content for blood sugar support. Chemical-free, shade-dried quality.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Jamun Seed Powder Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Jamboline</h4>
                                <p>Rich in Jamboline glucoside, known for regulating blood sugar conversion.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Pure</h4>
                                <p>Made purely from wild-harvested Jamun seeds. No additives or fillers.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Shade Dried</h4>
                                <p>Processed naturally to preserve vital alkaloids and antioxidants.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Fine Mesh</h4>
                                <p>Available in fine powder form for easy consumption and formulation.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you premium quality Jamun Seed Powder (Syzygium cumini), a powerful herbal remedy revered in Ayurveda for centuries. Sourced from wild-harvested Indian Blackberries, our seeds are meticulously cleaned, shade-dried, and pulverized to create a pure powder rich in Jamboline and Jambosine, essential for managing blood glucose levels naturally.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Raw Seed Powder</h4>
                            <ul>
                                <li><strong>Process:</strong> Sun Dried & Pulverized</li>
                                <li><strong>Purity:</strong> 100% Natural</li>
                                <li><strong>Use:</strong> Direct Consumption</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Extract Grade</h4>
                            <ul>
                                <li><strong>Concentration:</strong> High Alkaloid</li>
                                <li><strong>Solubility:</strong> Water Soluble</li>
                                <li><strong>Use:</strong> Pharmaceutical Capsules</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Organic Grade</h4>
                            <ul>
                                <li><strong>Certification:</strong> NOP / NPOP</li>
                                <li><strong>Origin:</strong> Wild Forest Harvest</li>
                                <li><strong>Use:</strong> Premium Health Foods</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Jamun Juice Powder</h4>
                            <ul>
                                <li><strong>Form:</strong> Spray Dried</li>
                                <li><strong>Flavor:</strong> Tangy & Sweet</li>
                                <li><strong>Use:</strong> Instant Drinks, Flavoring</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Syzygium cumini</td></tr>
                        <tr><th>Part Used</th><td>Seeds (Kernels)</td></tr>
                        <tr><th>Moisture</th><td>5% - 8% Max</td></tr>
                        <tr><th>Total Ash</th><td>5% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>1% Max</td></tr>
                        <tr><th>Mesh Size</th><td>60 - 80 Mesh</td></tr>
                        <tr><th>Color</th><td>Light Brown / Beige</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg</strong><br>HDPE Drums or Paper Bags with food-grade poly liner for moisture protection.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>100g / 200g</strong><br>Stand-up pouches or PET jars available for private label brands.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 10 - 12 Metric Tons<br><strong>40 FT:</strong> 20 - 22 Metric Tons<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Ayurveda & Pharma</h4>
                        <p>A primary ingredient in diabetic care formulations, churan (digestive powders), and herbal capsules.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Nutraceuticals</h4>
                        <p>Used in dietary supplements focused on blood sugar management, digestion, and skin health.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: How does Jamun Seed help?</span>
                        <span class="faq-a">It contains Jamboline, which checks the conversion of starch into sugar in cases of increased glucose levels.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it safe for consumption?</span>
                        <span class="faq-a">Yes, our powder is food-grade and processed in hygienic facilities. However, medical advice is recommended for dosage.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you add any preservatives?</span>
                        <span class="faq-a">No, our Jamun Seed Powder is 100% natural and free from any preservatives or additives.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you provide samples?</span>
                        <span class="faq-a">Yes, we provide samples for quality testing and lab analysis before bulk orders.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/jamunpw.avif",
  "description": "Export-grade Indian Jamun Seed Powder. High Jamboline content, shade dried, diabetes support.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "JAM-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/jamun-seed-powder-exporter-from-india.php",
    "priceCurrency": "USD",
