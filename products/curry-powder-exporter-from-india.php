<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CURRY POWDER
// ----------------------------------------------------------------
$productName  = "Curry Powder (Masala Blend)";
$categoryName = "POWDERED SPICES";
$bannerText   = "SAVORY";
$imagePath    = "../assets/images/currypw.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Authentic Curry Powder Manufacturer & Exporter India | Madras Blend | AGROX";
$pageDesc     = "Exporting premium Indian Curry Powder. Authentic Madras Curry Blend and Standard Mild blends available. Custom spice mixing services for global brands.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Authentic Curry Powder Blend" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Authentic Blend</h4>
                                <p>Traditional Indian recipes balancing coriander, turmeric, cumin, and fenugreek.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich Aroma</h4>
                                <p>Spices are roasted before grinding to release maximum flavor oils.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>No Fillers</h4>
                                <p>100% pure ground spices. No added starch, flour, or artificial colors.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Custom Heat</h4>
                                <p>Available in Mild, Medium, and Hot variants to suit different markets.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the authentic taste of India with our premium Curry Powder blends. Our masala is a precise formulation of high-quality Coriander, Turmeric, Cumin, Fenugreek, and Chilli, expert-roasted and ground to perfection. It provides the quintessential savory, golden base required for curries, stews, and marinades, delivering consistency in every batch.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Popular Blends</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Madras Curry Powder</h4>
                            <ul>
                                <li><strong>Flavor:</strong> Spicy & Robust</li>
                                <li><strong>Color:</strong> Deep Reddish-Yellow</li>
                                <li><strong>Use:</strong> Authentic Indian Curries</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Standard Mild Curry</h4>
                            <ul>
                                <li><strong>Flavor:</strong> Sweet & Savory</li>
                                <li><strong>Color:</strong> Bright Yellow</li>
                                <li><strong>Use:</strong> Western Palate, Soups</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Roasted Curry Powder</h4>
                            <ul>
                                <li><strong>Flavor:</strong> Nutty & Smoky</li>
                                <li><strong>Color:</strong> Dark Brown</li>
                                <li><strong>Use:</strong> Sri Lankan / South Indian Dishes</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Garam Masala</h4>
                            <ul>
                                <li><strong>Profile:</strong> Warming Spices</li>
                                <li><strong>Ingredients:</strong> Cloves, Cardamom, Cinnamon</li>
                                <li><strong>Use:</strong> Finishing Spice</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Primary Ingredients</th><td>Coriander, Turmeric, Cumin, Chilli</td></tr>
                        ...
                        <tr><th>Additives</th><td>None / Salt (On Request)</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>Multi-wall Paper Bags or PP Bags with food-grade inner liner to preserve freshness.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Jars</strong><br>100g to 1kg laminated pouches. We offer complete Private Labeling solutions for brands.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 17 - 18 Metric Tons<br><strong>40 FT:</strong> 26 - 27 Metric Tons<br><strong>Lead Time:</strong> 15-20 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        ...
                        <p>Essential for manufacturers of instant curries, frozen meals, and noodle tastemakers.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Sauces & Marinades</h4>
                        <p>Used in barbecue sauces, salad dressings, and mayonnaise to add a savory, spiced kick.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you customize the blend recipe?</span>
                        <span class="faq-a">Yes, we can adjust the ratio of Chilli, Pepper, or Turmeric to match your specific flavor profile and color requirements.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Does your curry powder contain MSG?</span>
                        <span class="faq-a">No, our standard curry powder is 100% natural spices and free from MSG or artificial flavor enhancers.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">18 to 24 months when stored in sealed packaging in cool, dry conditions.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer allergen-free blends?</span>
                        <span class="faq-a">Yes, we can produce blends in a controlled environment to ensure they are free from mustard or celery if required.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/currypw.jpg",
  "description": "Authentic Indian Curry Powder Blend. Madras and Standard varieties. Custom blends available.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CUR-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/curry-powder-exporter-from-india.php",
    "priceCurrency": "USD",
