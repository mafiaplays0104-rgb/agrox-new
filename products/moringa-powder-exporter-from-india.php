<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: MORINGA POWDER
// ----------------------------------------------------------------
$productName  = "Moringa Leaf Powder";
$categoryName = "POWDERED SPICES";
$bannerText   = "SUPERFOOD";
$imagePath    = "../assets/images/moringapw.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Organic Moringa Powder Exporter India | Superfood Grade | AGROX";
$pageDesc     = "Certified Organic Moringa Leaf Powder Exporter from India. Premium shade-dried, vibrant green color, high protein & antioxidant content. Bulk supplier.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Organic Moringa Powder Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Vibrant Green</h4>
                                <p>Premium quality indicated by bright green color, processed via shade drying.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Packed with Protein, Vitamin A, Calcium, and Iron. True Superfood.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Fine Mesh</h4>
                                <p>Micro-fine powder (100-200 mesh) for easy solubility in smoothies.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Organic</h4>
                                <p>Certified Organic cultivation without pesticides or heavy metals.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the "Miracle Tree" superfood in its most potent form. Our Organic Moringa Leaf Powder is made from hand-picked young leaves of the Moringa Oleifera tree. We utilize a specialized shadow-drying process that preserves the vibrant green color and locks in vital nutrients like antioxidants, amino acids, and vitamins, making it superior to sun-dried alternatives.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Superfood Grade</h4>
                            <ul>
                                <li><strong>Color:</strong> Bright Green</li>
                                <li><strong>Process:</strong> Shade Dried</li>
                                <li><strong>Use:</strong> Smoothies, Capsules</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Standard Grade</h4>
                            <ul>
                                <li><strong>Color:</strong> Dull Green</li>
                                <li><strong>Process:</strong> Mechanical Drying</li>
                                <li><strong>Use:</strong> Tea Blends, Animal Feed</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Moringa Capsules</h4>
                            <ul>
                                <li><strong>Form:</strong> 500mg Veg Capsules</li>
                                <li><strong>Purity:</strong> 100% Powder</li>
                                <li><strong>Use:</strong> Dietary Supplements</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Moringa Tea Cut</h4>
                            <ul>
                                <li><strong>Form:</strong> Coarse Cut Leaves</li>
                                <li><strong>Flavor:</strong> Earthy & Grassy</li>
                                <li><strong>Use:</strong> Herbal Tea Infusions</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Protein</th><td>25% - 30%</td></tr>
                        <tr><th>Moisture</th><td>8% Max</td></tr>
                        <tr><th>Total Ash</th><td>10% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>1% Max</td></tr>
                        <tr><th>Mesh Size</th><td>80 - 100 Mesh (Fine)</td></tr>
                        <tr><th>Heavy Metals</th><td>Within EU Limits</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>20kg / 25kg</strong><br>Double layered Polybags inside Paper Drums or Corrugated Boxes for complete protection.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Stand-up Pouches</strong><br>100g, 250g, 500g Kraft or Foil pouches. Private labeling (white label) available.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 10 - 11 Metric Tons<br><strong>40 FT:</strong> 20 - 21 Metric Tons<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        ...
                        <p>A top ingredient for multivitamins, green superfood blends, and protein powders.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Cosmetics</h4>
                        <p>Used in face masks, scrubs, and soaps for its skin-purifying and anti-aging properties.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Why is color important for Moringa?</span>
                        <span class="faq-a">A bright green color indicates low-temperature drying, meaning nutrients are intact. Brownish powder means oxidation or high heat damage.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it certified organic?</span>
                        <span class="faq-a">Yes, our Moringa is cultivated on certified organic farms and carries USDA NOP and EU Organic certifications.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it water soluble?</span>
                        <span class="faq-a">Moringa powder is fibrous plant matter, so it doesn't fully dissolve like sugar, but our fine mesh grade suspends well in liquids.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply Moringa Oil?</span>
                        <span class="faq-a">Yes, we also produce cold-pressed Moringa Seed Oil (Ben Oil) for the cosmetic industry.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/moringapw.avif",
  "description": "Export-grade Organic Moringa Powder from India. Shade dried, high protein, vibrant green superfood.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "MOR-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/moringa-powder-exporter-from-india.php",
    "priceCurrency": "USD",
