<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CARDAMOM POWDER
// ----------------------------------------------------------------
$productName  = "Cardamom Powder (Elaichi)";
$categoryName = "POWDERED SPICES";
$bannerText   = "FRAGRANT";
$imagePath    = "../assets/images/cardamompw.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Green Cardamom Powder Exporter India | Premium Alleppey Grade | AGROX";
$pageDesc     = "Exporting high-aroma Green Cardamom Powder from India. Cool-ground from Alleppey Green pods to retain essential oils. Pure, husk-free quality for bakery and beverages.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Green Cardamom Powder" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sourced from Idukki, Kerala – renowned for the world's best aroma.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Cool Grinding</h4>
                                <p>Processed at low temperatures to prevent loss of volatile essential oils.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Husk Free</h4>
                                <p>Premium grade contains only ground seeds, zero husk for maximum potency.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Aroma Lock</h4>
                                <p>Packaged in high-barrier material instantly after grinding to seal the fragrance.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports the "Queen of Spices" in its most convenient form. Our Green Cardamom Powder (Elaichi) is derived from choicest green pods grown in the Cardamom Hills of Kerala. By employing cryogenic grinding technology, we ensure the powder retains its intense floral aroma, cooling camphor-like flavor, and essential volatile oils, making it perfect for desserts and beverages.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Premium Grade</h4>
                            <ul>
                                <li><strong>Source:</strong> 8mm Bold Pods</li>
                                <li><strong>Color:</strong> Light Greenish-Brown</li>
                                <li><strong>Use:</strong> High-end Sweets</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Aroma Grade</h4>
                            <ul>
                                <li><strong>Source:</strong> Alleppey Green</li>
                                <li><strong>Features:</strong> High Volatile Oil</li>
                                <li><strong>Use:</strong> Tea Blends, Extracts</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Baker's Grade</h4>
                            <ul>
                                <li><strong>Source:</strong> Mixed Sizes</li>
                                <li><strong>Flavor:</strong> Balanced</li>
                                <li><strong>Use:</strong> Cakes, Cookies, Bread</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Organic Grade</h4>
                    ...
                    <table class="spec-table">
                        <tr><th>Volatile Oil</th><td>5% - 8% (High)</td></tr>
                        <tr><th>Moisture</th><td>10% Max</td></tr>
                        <tr><th>Total Ash</th><td>6% Max</td></tr>
                        ...
                        <tr><th>Origin</th><td>Kerala, India</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>10kg / 25kg</strong><br>Aluminum Foil Bags inside Corrugated Boxes. Foil is essential to prevent aroma loss.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Small Packs</strong><br>50g, 100g, 200g jars or zip-lock pouches. Nitrogen flushed for extended shelf life.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 12 - 13 Metric Tons<br><strong>40 FT:</strong> 24 - 25 Metric Tons<br><strong>Lead Time:</strong> 10-15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Dairy & Sweets</h4>
                        <p>A must-have for Indian sweets (Mithai), ice creams, kheer, and flavored yogurts.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Beverage Industry</h4>
                        <p>Used extensively in Masala Chai premixes, herbal teas, and flavored coffee blends.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your powder made from whole pods or seeds?</span>
                        <span class="faq-a">Our Premium Grade is made from pure seeds for maximum flavor. We also offer Whole Pod powder (husk included) for budget requirements.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you prevent flavor loss?</span>
                        <span class="faq-a">We use Cryogenic (Cool) Grinding technology which keeps the temperature below 40°C, preserving the volatile oils.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">18 months when stored in sealed aluminum foil packaging in a cool, dark place.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply Cardamom Oil?</span>
                        <span class="faq-a">Yes, we also export steam-distilled Cardamom Essential Oil for perfumery and flavoring.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/cardamompw.jpg",
  "description": "Export-grade Indian Green Cardamom Powder. Alleppey Green quality, cool ground, high aroma.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CAR-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/cardamom-powder-exporter-from-india.php",
    "priceCurrency": "USD",
