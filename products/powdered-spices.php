<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: POWDERED SPICES
// ----------------------------------------------------------------
$pageTitle = "Powdered Spices Exporter India | Bulk Turmeric, Chilli & Curry Powder";
$metaDescription = "Premium Grade Ground Spices exporter from India. AGROX offers cryogenically ground Turmeric, Chilli, Coriander, and custom Curry Blends with high color values.";
$canonicalURL = "https://www.theagroxgroup.com/powdered-spices.php";
...
<div class="banner-wrapper">
    <img src="../assets/images/bannerproduct.avif" alt="Powdered Spices Banner" class="banner-img-responsive">
    <div class="banner-scroll-text" id="bgText">GROUND SPICES</div>
    <h1 class="banner-title" id="fgText">POWDERED SPICES</h1> 
    ...
    <div class="wide-display-area">
        <div class="glass-panel">
            ...
            <div class="category-intro">
                <span class="cat-subtitle">GROUND PERFECTION</span>
                <h2 class="cat-main-title">The Art of Fine Grinding</h2>
                <p class="cat-desc">
                    AGROX employs advanced Low-Temperature Grinding (LTG) technology to ensure our powdered spices retain their original essential oils, color, and aroma. Pure, unadulterated, and ground to the perfect mesh size for culinary and industrial applications.
                </p>
            </div>

            <div class="grid-4">
                
                <a href="turmeric-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">CURCUMIN</div>
                    <div class="harvest-img-box"><img src="../assets/images/turmericpw.avif" alt="Turmeric Powder Haldi" loading="lazy"></div>
                ...
                <a href="coriander-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">PURE</div>
                    <div class="harvest-img-box"><img src="../assets/images/corianderpw.avif" alt="Coriander Powder" loading="lazy"></div>
                    <div class="harvest-content">
                ...
                <a href="cumin-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">ROASTED</div>
                    <div class="harvest-img-box"><img src="../assets/images/cuminpw.avif" alt="Cumin Powder Jeera" loading="lazy"></div>
                    <div class="harvest-content">
                ...
                <a href="garlic-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">PUNGENT</div>
                    <div class="harvest-img-box"><img src="../assets/images/garlicpw.avif" alt="Garlic Powder" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">LAHSOON</span>
                        <h3>Garlic Powder</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="ginger-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">ZESTY</div>
                    <div class="harvest-img-box"><img src="../assets/images/gingerpw.avif" alt="Ginger Powder" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">SOONTH</span>
                        <h3>Ginger Powder</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="cinnamon-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">SWEET</div>
                    <div class="harvest-img-box"><img src="../assets/images/cinnamonpw.avif" alt="Cinnamon Powder" loading="lazy"></div>
                    <div class="harvest-content">
                ...
                <a href="chilli-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">FIERY</div>
                    <div class="harvest-img-box"><img src="../assets/images/redchillipw.avif" alt="Red Chilli Powder" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">LAL MIRCH</span>
                        <h3>Chilli Powder</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="curry-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">BLEND</div>
                    <div class="harvest-img-box"><img src="../assets/images/currypw.avif" alt="Curry Powder" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">MASALA</span>
                        <h3>Curry Powder</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="cardamom-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">AROMATIC</div>
                    <div class="harvest-img-box"><img src="../assets/images/cardamompw.avif" alt="Cardamom Powder" loading="lazy"></div>
                    <div class="harvest-content">
                ...
                <a href="moringa-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">SUPERFOOD</div>
                    <div class="harvest-img-box"><img src="../assets/images/moringapw.avif" alt="Moringa Powder" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">DRUMSTICK</span>
                        <h3>Moringa Powder</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>

                <a href="jamun-seed-powder-exporter-from-india.php" class="harvest-card">
                    <div class="harvest-badge">HERBAL</div>
                    <div class="harvest-img-box"><img src="../assets/images/jamunpw.avif" alt="Jamun Seed Powder" loading="lazy"></div>
                    <div class="harvest-content">
                        <span class="harvest-cat">DIABETIC</span>
                        <h3>Jamun Seed Powder</h3>
                    </div>
                    <div class="card-arrow-box"><i class="fas fa-arrow-right"></i></div>
                </a>
            ...
            <div class="marquee-section">
                <div class="marquee-content">
                    <span class="marquee-text">PREMIUM GROUND SPICES • COLD GRINDING TECHNOLOGY • AGROX GLOBAL EXPORTS •</span>
                    <span class="marquee-text">PREMIUM GROUND SPICES • COLD GRINDING TECHNOLOGY • AGROX GLOBAL EXPORTS •</span>
                </div>
            </div>
            ...
            <div class="cine-section">
                <div class="cine-container">
                    ...
                    <div class="cine-sticky-col">
                        ...
                        <h2 class="cine-big-title">THE GLOBAL<br>STANDARD FOR<br><span class="cine-gold">GROUND SPICES</span></h2>
                        
                        <div class="stats-container">
                            <div class="stat-box">
                                <span class="stat-value">MESH</span>
                                <span class="stat-label">CUSTOM SIZE</span>
                            </div>
                            <div class="stat-box">
                            ...
                            <div class="stat-box">
                                <span class="stat-value">COOL</span>
                                <span class="stat-label">GRINDING</span>
                            </div>
                            <div class="stat-box">
                    ...
                    <div class="cine-scroll-col">
                        ...
                        <div class="text-reveal-mask">
                            <p class="cine-text">
                                The secret to perfect spice powder lies in the temperature. Standard grinding generates heat that destroys volatile oils. At AGROX, we use <strong>Cryogenic Grinding</strong> (Cool Milling) technology that maintains temperatures below 0°C, ensuring that the aroma, color, and flavor of the original spice are perfectly preserved.
                            </p>
                        </div>

                        <div class="text-reveal-mask">
                            <p class="cine-text">
                                Our range includes high-curcumin <strong>Turmeric Powder</strong>, vibrant red <strong>Chilli Powder</strong> with custom heat levels (SHU), and aromatic <strong>Coriander Powder</strong>. All products are passed through rare-earth magnets and metal detectors to guarantee safety.
                            </p>
                        </div>
                        ...
                        <div class="features-grid">
                            ...
                            <div class="feature-card">
                                ...
                                <h4 class="f-title">Mesh Accuracy</h4>
                                <p class="f-desc">We customize the particle size (Mesh 40 to Mesh 100) based on your specific application needs.</p>
                            </div>

                            <div class="feature-card">
                                <i class="fas fa-temperature-low f-icon"></i>
                                <h4 class="f-title">Aroma Retention</h4>
                                <p class="f-desc">Our cold processing technique retains up to 95% of the natural essential oils compared to standard milling.</p>
                            </div>

                            <div class="feature-card">
                                <i class="fas fa-shield-alt f-icon"></i>
                                <h4 class="f-title">Food Safety</h4>
                                <p class="f-desc">Steam sterilized options available to reduce microbial load (Salmonella/E.Coli) to international standards.</p>
                            </div>

                            <div class="feature-card">
                                <i class="fas fa-palette f-icon"></i>
                                <h4 class="f-title">Color Consistency</h4>
                                <p class="f-desc">We test every batch for ASTA color values to ensure your product looks as vibrant as it tastes.</p>
                            </div>
                ...
                <div class="cine-container" style="flex-direction: column; gap: 30px;">
                     ...
                     <div class="process-wrapper">
                         <div class="process-step">
                             ...
                             <h4 class="process-title">Cleaning</h4>
                             <p class="process-desc">Raw whole spices are destoned, air-classified, and magnetically cleaned to remove all impurities.</p>
                         </div>
                         <div class="process-step">
                             <div class="process-step-num">02</div>
                             <h4 class="process-title">Cold Grinding</h4>
                             <p class="process-desc">Grinding is done in a jacketed mill with liquid nitrogen cooling to prevent heat damage.</p>
                         </div>
                         <div class="process-step">
                             <div class="process-step-num">03</div>
                             <h4 class="process-title">Sifting</h4>
                             <p class="process-desc">The powder is sifted through varying mesh screens to achieve uniform particle size.</p>
                         </div>
                         <div class="process-step">
                             <div class="process-step-num">04</div>
                             <h4 class="process-title">Packing</h4>
                             <p class="process-desc">Immediate packing in laminated pouches or bulk liners to lock in freshness.</p>
                         </div>
                     </div>
                </div>
            </div>
            ...
            <section class="final-content">
                <div class="final-max-width">
                    ...
                    <p class="cine-text" style="transform: none; opacity: 1; margin-bottom: 40px; color: #ccc;">
                        Partner with AGROX for premium ground spices that deliver consistency. From bulk sacks to private label jars, we cover it all.
                    </p>
