<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CHICKPEAS (KABULI CHANA)
// ----------------------------------------------------------------
$productName  = "Chickpeas (Kabuli Chana)";
$categoryName = "PULSES & LENTILS";
$bannerText   = "GARBANZO"; // International trade name
$imagePath    = "../assets/images/chickpeas.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Kabuli Chickpeas (Garbanzo) Exporter India | AGROX";
$pageDesc     = "Buy export-quality Kabuli Chickpeas (Garbanzo Beans) in bulk. Available in 42/44, 44/46, 58/60 and 75/80 counts. Sortex cleaned and machine polished.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Kabuli Chickpeas Garbanzo Beans" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Size Matters</h4>
                                <p>Available in premium large calibers (12mm, 10mm) and specific counts (42/44, 44/46).</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Processed through optical color sorters to ensure creamy, uniform seeds free from impurities.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Protein Rich</h4>
                                <p>High fiber and protein content, ideal for Hummus, Falafel, and canning industries.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sourced from Madhya Pradesh (Indore) and Rajasthan, known for the best Kabuli Chana.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the finest quality Kabuli Chickpeas (Garbanzo Beans) from India. Renowned for their nutty flavor, creamy texture, and impressive size, our chickpeas are a staple in global cuisines ranging from Mediterranean to Indian. We grade our chickpeas by "Count Per Ounce" to meet specific international standards, ensuring you receive the exact caliber required for your business.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Grading & Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>42/44 Count (Extra Bold)</h4>
                            <ul>
                                <li><strong>Size:</strong> 12mm - 13mm approx.</li>
                                <li><strong>Features:</strong> Largest premium size.</li>
                                <li><strong>Use:</strong> Gourmet canning, Roasted snacks.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>44/46 Count (Bold)</h4>
                            <ul>
                                <li><strong>Size:</strong> 11mm - 12mm approx.</li>
                                <li><strong>Features:</strong> Standard Export Quality.</li>
                                <li><strong>Use:</strong> Hummus, Retail Packs.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>58/60 Count (Medium)</h4>
                            <ul>
                                <li><strong>Size:</strong> 8mm - 9mm approx.</li>
                                <li><strong>Features:</strong> Economical & Versatile.</li>
                                <li><strong>Use:</strong> Flour (Besan), Curries.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>75/80 Count (Small)</h4>
                            <ul>
                                <li><strong>Size:</strong> 7mm - 8mm approx.</li>
                                <li><strong>Features:</strong> Small but flavorful.</li>
                                <li><strong>Use:</strong> Bulk Food Service, Grinding.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Cicer arietinum</td></tr>
                        ...
                        <tr><th>Broken / Split</th><td>2% Maximum</td></tr>
                        <tr><th>Weevilled Seeds</th><td>Nil</td></tr>
                        <tr><th>Green/Brown Seeds</th><td>1% Maximum</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Strong PP Bags</strong><br>We use high-density Polypropylene (PP) bags or Jute bags to ensure breathability and protection during long sea transits.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Hummus & Falafel</strong><br>Our high-count Kabuli chickpeas soak well and blend perfectly for smooth hummus and crispy falafels.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 24 Metric Tons<br><strong>Availability:</strong> New Crop (Feb - April)<br><strong>Origin:</strong> India</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What does "Count" mean in Chickpeas?</span>
                        <span class="faq-a">Count refers to the number of grains per US Ounce (28.35g). A lower count (e.g., 42/44) means larger beans, while a higher count (e.g., 75/80) means smaller beans.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Are your chickpeas suitable for canning?</span>
                        <span class="faq-a">Yes, our 42/44 and 44/46 counts are specifically selected for the canning industry due to their size retention after cooking.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer Desi Chickpeas (Brown)?</span>
                        <span class="faq-a">Yes, we also supply Desi Chickpeas (Brown/Kala Chana) separately. This page features the white Kabuli variety.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you prevent infestation during transit?</span>
                        <span class="faq-a">We conduct mandatory fumigation of the container before sealing and provide a Fumigation Certificate with every shipment.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/chickpeas.jpg",
  "description": "Premium Kabuli Chickpeas (Garbanzo Beans) exporter from India. Available in 42/44, 44/46, 58/60 counts. Sortex cleaned and polished.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CHICKPEAS-KAB-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/chickpeas-kabuli-chana-exporter-from-india.php",
    "priceCurrency": "USD",
