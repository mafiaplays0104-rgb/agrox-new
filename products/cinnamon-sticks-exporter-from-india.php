<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CINNAMON STICKS
// ----------------------------------------------------------------
$productName  = "Cinnamon Sticks (Dalchini)";
$categoryName = "WHOLE SPICES";
$bannerText   = "AROMATIC";
$imagePath    = "../assets/images/cinnamonwh.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Cinnamon Sticks Exporter India | Ceylon Quills & Cassia Bark | AGROX";
$pageDesc     = "Exporting premium Cinnamon Sticks (Dalchini) from India. We supply authentic Ceylon Quills (True Cinnamon) and robust Cassia Bark. Hand-rolled, high oil content.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Cinnamon Sticks Whole" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Hand Rolled</h4>
                                <p>Authentic Ceylon grade sticks are meticulously hand-rolled into delicate quills.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Rich Essential Oil</h4>
                                <p>High volatile oil content ensures a potent, sweet, and woody aroma.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Kerala Origin</h4>
                                <p>Sourced from the lush rainforests of Kerala (Western Ghats), famous for True Cinnamon.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Premium Cut</h4>
                                <p>Available in various cuts (5cm - 20cm) to suit retail and industrial needs.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports finest quality Whole Cinnamon Sticks, known as "Dalchini". We source both the delicate, paper-thin **True Cinnamon (Ceylon variety)** from Kerala and the robust, thick-barked **Cassia** from Meghalaya. Our sticks are hand-selected, cleaned, and cut to precise lengths. They are celebrated for their sweet fragrance and essential oils, making them perfect for infusions, curries, and essential oil extraction.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Ceylon Quills (True)</h4>
                            <ul>
                                <li><strong>Type:</strong> Rolled, Multi-layered</li>
                                <li><strong>Flavor:</strong> Delicate, Sweet, Citrusy</li>
                                <li><strong>Use:</strong> Desserts, Gourmet Tea</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Cassia Bark</h4>
                            <ul>
                                <li><strong>Type:</strong> Thick, Single Layer</li>
                                <li><strong>Flavor:</strong> Strong, Spicy, Pungent</li>
                                <li><strong>Use:</strong> Curries, Biryani</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Split Cassia</h4>
                            <ul>
                                <li><strong>Form:</strong> Broken / Split</li>
                                <li><strong>Oil Content:</strong> High</li>
                                <li><strong>Use:</strong> Grinding, Extraction</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Cigarette Cut</h4>
                            <ul>
                                <li><strong>Length:</strong> 3 inches - 5 inches</li>
                                <li><strong>Appearance:</strong> Uniform cut</li>
                                <li><strong>Use:</strong> Retail Packs, Decor</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Type</th><td>Quills (Ceylon) / Bark (Cassia)</td></tr>
                        <tr><th>Volatile Oil</th><td>1.0% - 2.5%</td></tr>
                        <tr><th>Moisture</th><td>12% Max</td></tr>
                        <tr><th>Length</th><td>6cm to 40cm (Customizable)</td></tr>
                        <tr><th>Diameter</th><td>6mm - 18mm</td></tr>
                        <tr><th>Foreign Matter</th><td>0.5% Max</td></tr>
                        <tr><th>Mold / Fungus</th><td>Absent</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>Carton Boxes or Jute Bags. Sticks are carefully stacked to prevent breakage during transit.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Jars / Pouches</strong><br>50g, 100g, 250g in clear PET jars or stand-up pouches to showcase the quill structure.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 6 - 8 Metric Tons (Voluminous)<br><strong>40 FT:</strong> 15 - 16 Metric Tons<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        ...
                        <p>High-oil Cassia and Cinnamon chips are distilled to produce Cinnamon Leaf Oil and Bark Oil for perfumery.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Food & Beverage</h4>
                        <p>Used as stirrers in hot chocolate/coffee and as a key spice in mulled wine and chai mixes.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the main difference between Cassia and True Cinnamon?</span>
                        <span class="faq-a">True Cinnamon (Ceylon) is tan, thin, and brittle with multiple layers. Cassia is dark reddish-brown, hard, and has a single thick layer.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer cut sizes?</span>
                        <span class="faq-a">Yes, we have precise cutting machines to provide "Cigarette Cut" sizes of 8cm, 10cm, or any custom length.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it safe for export to EU?</span>
                        <span class="faq-a">Yes, our Ceylon Cinnamon has very low Coumarin levels, making it safe and compliant with European food safety standards.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How is it packed to avoid breakage?</span>
                        <span class="faq-a">We use strong 5-ply corrugated carton boxes and bundle the sticks tightly to ensure they arrive intact.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/cinnamonst.avif",
  "description": "Export-grade Indian Cinnamon Sticks. Ceylon Quills and Cassia Bark varieties. Hand-rolled, high oil content.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CIN-ST-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/cinnamon-sticks-exporter-from-india.php",
    "priceCurrency": "USD",
