<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: FENUGREEK SEEDS
// ----------------------------------------------------------------
$productName  = "Fenugreek Seeds (Methi)";
$categoryName = "WHOLE SPICES";
$bannerText   = "GOLDEN";
$imagePath    = "../assets/images/fenugreek.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Fenugreek Seeds Exporter India | Machine Cleaned & Sortex Methi | AGROX";
$pageDesc     = "Exporting premium Fenugreek Seeds (Methi) from India. 99.5% Purity Sortex and Machine Cleaned grades available. Rich in protein and medicinal properties.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Premium Fenugreek Seeds Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Processed to 99.5% purity to ensure zero foreign matter and stones.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Golden Yellow</h4>
                                <p>Sourced from Rajasthan, known for bold seeds with a natural golden hue.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Protein</h4>
                                <p>Rich in fiber and protein, making it essential for nutraceutical use.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich Aroma</h4>
                                <p>Offers a strong, distinct maple-like aroma characteristic of fresh Methi.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports high-quality Fenugreek Seeds (Methi), a versatile spice with immense medicinal and culinary value. Cultivated in the arid regions of Rajasthan and Gujarat, our seeds are prized for their bold size and rich golden color. We offer machine-cleaned and Sortex-quality seeds, free from dust and stones, ensuring they meet the stringent standards of the pharmaceutical and food industries.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Sortex Cleaned</h4>
                            <ul>
                                <li><strong>Purity:</strong> 99.5%</li>
                                <li><strong>Appearance:</strong> Uniform Golden</li>
                                <li><strong>Use:</strong> Premium Retail, Pharma</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            ...
                            <ul>
                                ...
                                <li><strong>Appearance:</strong> Natural</li>
                                <li><strong>Use:</strong> Spice Powders, Curry</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Powder Quality</h4>
                            <ul>
                                <li><strong>Purity:</strong> 97% - 98%</li>
                                <li><strong>Size:</strong> Small / Mixed</li>
                        ...
                        <div class="variety-card">
                            ...
                            <ul>
                                ...
                                <li><strong>Origin:</strong> Certified Farms</li>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>PP Woven Bags or Jute Gunny Bags. Strong stitching to prevent spillage.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Jars</strong><br>100g to 1kg laminated pouches. Private labeling available for brands.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 21 - 22 Metric Tons<br><strong>40 FT:</strong> 26 - 27 Metric Tons<br><strong>Lead Time:</strong> 15-20 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        ...
                        <p>Extracted for Galactomannan and used in diabetes management supplements and lactation aids.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Pickles & Curry</h4>
                        <p>A key ingredient in mango pickles and curry powders (Panch Phoron, Sambar Masala).</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the main use of Fenugreek?</span>
                        <span class="faq-a">It is widely used for flavoring curries/pickles and extracted for medicinal use (controlling blood sugar).</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do the seeds germinate?</span>
                        <span class="faq-a">Yes, our seeds are raw and untreated (unless sterilization is requested), so they have a high germination rate for sprouts.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it Machine Cleaned?</span>
                        <span class="faq-a">Yes, we process the raw seeds through cleaning machines to remove dust, stones, and stalks.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you ship mixed containers?</span>
                        <span class="faq-a">Yes, Fenugreek is dense, so it mixes well with lighter spices like Coriander or Cumin in a container.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/fenugreekwh.avif",
  "description": "Export-grade Indian Fenugreek Seeds. Machine Cleaned and Sortex quality. Golden yellow, high purity.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "FEN-SD-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/fenugreek-seeds-exporter-from-india.php",
    "priceCurrency": "USD",
