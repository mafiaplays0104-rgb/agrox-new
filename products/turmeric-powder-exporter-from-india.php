<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: TURMERIC POWDER (FONTS + BLACK GLASS)
// ----------------------------------------------------------------
$productName  = "Turmeric Powder (Haldi)";
$categoryName = "TURMERIC POWDER";
$bannerText   = "CURCUMIN";
$imagePath    = "../assets/images/turmericpw.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Turmeric Powder (Haldi) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy high-curcumin Turmeric Powder in bulk. AGROX is a leading manufacturer and exporter of Salem, Nizamabad, and Rajapore turmeric varieties directly from Indian farms.";
...
<style>
    /* --- TYPOGRAPHY SETUP --- */
    /* 1. Apply Poppins to Body/Text */
    body {
        font-family: 'Poppins', sans-serif;
    }
    
    /* 2. Apply Bebas Neue to Headings/Titles/Banner */
    ...
    .pkg-item strong {
        ...
        letter-spacing: 1.5px; /* Bebas looks better with slight spacing */
    }
    ...
    .banner-title {
        ...
        z-index: 5; margin: 0; 
        font-size: 7.5rem; /* Slightly larger for Bebas */
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Premium Turmeric Powder Export Quality" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>No artificial colors or additives. Certified free from Sudan dyes & Aflatoxins.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Curcumin</h4>
                                <p>Potent range from 2% to 5% Curcumin for max health benefits.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Export Grade</h4>
                                <p>FSSAI, ISO, & Spice Board certified. Compliant with EU & FDA norms.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sourced directly from Salem & Nizamabad farmers for best pricing.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX is a leading turmeric powder exporter and wholesale turmeric supplier in India, delivering premium-grade haldi powder to international markets. Our organic turmeric powder is sourced directly from the renowned turmeric-growing regions of Salem, Nizamabad, and Sangli, ensuring the highest curcumin content and superior quality for your business needs.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Premium Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Salem Turmeric (Premium)</h4>
                            <ul>
                                <li><strong>Curcumin:</strong> 3% - 4%</li>
                                <li><strong>Color:</strong> Bright Orange-Yellow</li>
                                <li><strong>Use:</strong> Retail Packs, Premium Blends</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Nizamabad (Alleppey)</h4>
                            <ul>
                                <li><strong>Curcumin:</strong> 2.5% - 3.5%</li>
                                <li><strong>Color:</strong> Rich Golden-Yellow</li>
                                <li><strong>Use:</strong> Curry Powders, Bulk Food</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Rajapore (Medicinal)</h4>
                            <ul>
                                <li><strong>Curcumin:</strong> 3% - 4.5%</li>
                                <li><strong>Color:</strong> Deep Saffron-Yellow</li>
                                <li><strong>Use:</strong> Pharma Extraction</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Madras Quality</h4>
                            <ul>
                                <li><strong>Curcumin:</strong> 2% - 2.5%</li>
                                <li><strong>Color:</strong> Light Yellow</li>
                                <li><strong>Use:</strong> Budget / Institutional</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        ...
                        <?php endforeach; ?>
                        <tr><th>Moisture</th><td>10% Maximum</td></tr>
                        <tr><th>Total Ash</th><td>7% Maximum</td></tr>
                        <tr><th>Mesh Size</th><td>80 - 100 Mesh (Fine Powder)</td></tr>
                        <tr><th>Volatile Oil</th><td>2% - 5%</td></tr>
                        <tr><th>Chromate Test</th><td>Negative</td></tr>
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>HDPE / PP Woven Bags with inner liner to prevent moisture absorption. Ideal for wholesale and re-packers.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail & Private Label</h4>
                        <p><strong>White Label Services</strong><br>We offer customized pouches (500g, 1kg) and paper bags with your branding. Full design and printing support available.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 18-19 Metric Tons<br><strong>40 FT:</strong> 27-28 Metric Tons<br><strong>Lead Time:</strong> 15-20 Days from Order</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Food & Beverage</h4>
                        <p>Used in curry powders, spice blends, ready-to-eat meals, sauces, pickles, and golden milk latte mixes. Our turmeric provides vibrant natural color and distinct earthy flavor.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Pharmaceuticals & Nutraceuticals</h4>
                        <p>High-curcumin Rajapore turmeric is widely used for Curcumin extraction, dietary supplements, immunity boosters, and Ayurvedic medicines.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is your Minimum Order Quantity (MOQ)?</span>
                        <span class="faq-a">For export shipments, our MOQ is 1 Metric Ton (1000 kg). For domestic bulk inquiries, please contact sales.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you provide Lab Reports (COA)?</span>
                        <span class="faq-a">Yes, every batch comes with a Certificate of Analysis (COA) covering Curcumin %, Moisture, Ash, and Microbial tests.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply Organic Certified Turmeric?</span>
                        <span class="faq-a">Absolutely. We offer USDA and EU Organic certified turmeric powder sourced from certified organic farms.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What are your shipping terms?</span>
                        <span class="faq-a">We support FOB (Free on Board), CIF (Cost, Insurance, Freight), and CNF to all major global ports.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/turmericpw.avif",
  "description": "Buy premium high-curcumin Turmeric Powder from AGROX. 100% Pure, Export Grade Haldi Powder from Salem and Nizamabad. Bulk supplier.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "TURM-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/turmeric-powder-exporter-from-india.php",
    "priceCurrency": "USD",
