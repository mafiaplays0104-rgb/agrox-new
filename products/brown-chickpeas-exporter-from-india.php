<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: BROWN CHICKPEAS (KALA CHANA)
// ----------------------------------------------------------------
$productName  = "Brown Chickpeas (Kala Chana)";
$categoryName = "PULSES & LENTILS";
$bannerText   = "DESI CHANA"; // Text that scrolls behind the title
$imagePath    = "../assets/images/brownchickpea.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Brown Chickpeas (Kala Chana) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy export-quality Brown Chickpeas (Desi Chana) in bulk. High protein, iron-rich, and Sortex cleaned. Ideal for sprouting, milling (Besan), and curries.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Brown Chickpeas Kala Chana Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Iron Rich</h4>
                                <p>An excellent source of Iron and Protein. Essential for vegetarian and vegan diets.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Desi Origin</h4>
                                <p>Authentic Indian 'Desi' variety with a rough outer coat and intense nutty flavor.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Processed through optical color sorters to ensure 99% purity and uniform grain size.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Versatile Use</h4>
                                <p>Perfect for traditional curries, sprouting for salads, or milling into Besan flour.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports high-quality Brown Chickpeas (Kala Chana), also known as Desi Chickpeas. Unlike the larger Kabuli variety, these are smaller with a dark brown, rough skin and a yellow interior. They are a powerhouse of nutrition and a staple in Indian households for making spicy curries and nutritious sprouts. We source our Desi Chana from the arid regions of Rajasthan and MP, ensuring robust flavor and texture.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Desi Chana (Whole)</h4>
                            <ul>
                                <li><strong>Size:</strong> 6mm - 7mm.</li>
                                <li><strong>Color:</strong> Dark Brown / Black.</li>
                                <li><strong>Use:</strong> Curries, Boiled Snacks.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Sprouting Grade</h4>
                            <ul>
                                <li><strong>Germination:</strong> > 95% Rate.</li>
                                <li><strong>Age:</strong> Fresh New Crop.</li>
                                <li><strong>Use:</strong> Healthy Salads, Raw Diet.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Chana Dal (Split)</h4>
                            <ul>
                                <li><strong>Form:</strong> Split & Husked Desi Chana.</li>
                                <li><strong>Color:</strong> Bright Yellow.</li>
                                <li><strong>Use:</strong> Dal Tadka, Sweets.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Milling Quality</h4>
                            <ul>
                                <li><strong>Type:</strong> High Starch Content.</li>
                                <li><strong>Purpose:</strong> For making Besan (Gram Flour).</li>
                                <li><strong>Cost:</strong> Economical Bulk Grade.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        ...
                        <tr><th>Purity</th><td>99% (Machine Cleaned / Sortex)</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>PP Woven Bags</strong><br>We pack in strong 25kg or 50kg Polypropylene bags to ensure the grains remain dry and pest-free during sea transit.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Curry & Flour</strong><br>Used whole in 'Kala Chana Masala' or ground into 'Besan' (Gram Flour), which is the base for pakoras and sweets.</p>
                    </div>
                    <div class="info-card">
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Kabuli and Desi Chana?</span>
                        <span class="faq-a">Kabuli Chana is large and white/cream. Desi Chana (Kala Chana) is smaller, dark brown, and has a stronger, nuttier flavor and higher fiber content.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your Kala Chana suitable for sprouting?</span>
                        <span class="faq-a">Yes, we select fresh crop batches specifically for their high germination rate, making them perfect for sprouting.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply Chana Dal as well?</span>
                        <span class="faq-a">Yes, we supply both the whole brown chickpea and its split version (Chana Dal), which is yellow and husked.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you export Gram Flour (Besan)?</span>
                        <span class="faq-a">We primarily export the whole grain, but we can arrange for processed Besan (Gram Flour) for bulk orders upon request.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/brownchickpea.jpg",
  "description": "Premium Brown Chickpeas (Desi Chana) exporter from India. Sortex cleaned, high germination sprouting grade available in bulk.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CHANA-DESI-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/brown-chickpeas-exporter-from-india.php",
    "priceCurrency": "USD",
