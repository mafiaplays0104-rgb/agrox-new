<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CASHEW NUTS (KAJU)
// ----------------------------------------------------------------
$productName  = "Cashew Nuts (Kaju)";
$categoryName = "DRY FRUITS & NUTS";
$bannerText   = "CASHEW KERNELS"; // Trade name
$imagePath    = "../assets/images/cashew.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Cashew Nuts (W240, W320) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy premium Indian Cashew Kernels in bulk. We export W180, W240, W320 grades and Splits. Vacuum packed for freshness and Sortex graded.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Cashew Nuts W240 W320 Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Premium "W" Grade</h4>
                                <p>Strictly graded as per international standards (White Wholes). Guaranteed count and size.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Vacuum Packed</h4>
                                <p>Sealed in vacuum packs or tins with CO2 flushing to retain freshness and crunchiness.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Heart Healthy</h4>
                                <p>Rich in healthy monounsaturated fats, protein, and essential minerals like copper and magnesium.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Origin India</h4>
                                <p>Sourced from Kerala and Goa, known for producing the world's best-tasting cashew kernels.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports the finest quality Indian Cashew Kernels (Kaju), renowned globally for their buttery taste and consistent quality. We process raw nuts in hygienic, HACCP-certified facilities to produce a wide range of grades including W180, W240, and W320. Our cashews are carefully dried, peeled, and graded to ensure a perfect crunch and ivory-white appearance in every pack.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Popular Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>W-180 (King of Cashew)</h4>
                            <ul>
                                <li><strong>Count:</strong> 170-180 nuts/lb.</li>
                                <li><strong>Size:</strong> Super Jumbo (Very Large).</li>
                                <li><strong>Use:</strong> Premium Gifting, Luxury Snacks.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>W-240 (Jumbo)</h4>
                            <ul>
                                <li><strong>Count:</strong> 220-240 nuts/lb.</li>
                                <li><strong>Size:</strong> Large.</li>
                                <li><strong>Use:</strong> Export Standard, Retail Packs.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>W-320 (Standard)</h4>
                            <ul>
                                <li><strong>Count:</strong> 300-320 nuts/lb.</li>
                                <li><strong>Size:</strong> Medium.</li>
                                <li><strong>Use:</strong> Most popular and widely available.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Splits & Pieces (LWP/SWP)</h4>
                            <ul>
                                <li><strong>Type:</strong> Broken kernels (Large/Small).</li>
                                <li><strong>Quality:</strong> Same taste, broken shape.</li>
                                <li><strong>Use:</strong> Bakeries, Confectionery, Paste.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Anacardium occidentale</td></tr>
                        <tr><th>Grade</th><td>W210, W240, W320, W450, Splits</td></tr>
                        <tr><th>Moisture</th><td>5% Maximum</td></tr>
                        <tr><th>Broken Kernels</th><td>Max 5% (in Whole grades)</td></tr>
                        <tr><th>Foreign Matter</th><td>Nil</td></tr>
                        <tr><th>Insect Damage</th><td>Nil</td></tr>
                        <tr><th>Crop Year</th><td>Current Year</td></tr>
                        <tr><th>Packaging</th><td>11.34kg / 22.68kg Cartons</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Tins & Pouches</strong><br>We offer 10kg/11.34kg Tin packing (infused with CO2) or Vacuum Pouches packed in cardboard cartons to prevent breakage.</p>
                    </div>
                    <div class="info-card">
                        <h4>Processing</h4>
                        <p><strong>Steam Roasted</strong><br>Our raw cashews are steam roasted and air-cooled to remove the shell liquid (CNSL) safely while preserving the kernel.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> Approx. 700 Cartons (15-16 MT)<br><strong>Availability:</strong> Year-round<br><strong>Origin:</strong> India</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What does "W" stand for in grading?</span>
                        <span class="faq-a">"W" stands for "White Whole," indicating the kernel is whole (unbroken) and has a clean, ivory-white color.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between W240 and W320?</span>
                        <span class="faq-a">The number represents kernels per pound. W240 has fewer, larger nuts per pound compared to W320, making W240 a more premium, larger size.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you supply Roasted & Salted Cashews?</span>
                        <span class="faq-a">Yes, we can supply value-added Roasted, Salted, or Flavored cashews in retail consumer packaging upon request.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you prevent insect infestation?</span>
                        <span class="faq-a">We use vacuum packing and CO2 flushing, combined with proper fumigation before shipment, to ensure zero infestation.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Cashew Nuts (W240, W320)",
  "image": "https://theagroxgroup.org/assets/images/cashew.avif",
  "description": "Premium Indian Cashew Nuts (Kaju) Exporter. Wholesale supplier of W180, W240, W320 grades. Vacuum packed and Sortex graded.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CASHEW-W240-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/cashew-nuts-exporter-from-india.php",
    "priceCurrency": "USD",
