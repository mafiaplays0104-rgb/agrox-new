<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: DATES (KHAJOOR)
// ----------------------------------------------------------------
$productName  = "Dates (Khajoor)";
$categoryName = "DRY FRUITS & NUTS";
$bannerText   = "NATURE'S CANDY"; // Text scrolling behind title
$imagePath    = "../assets/images/dates.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Dates (Khajoor) Importer & Exporter India | AGROX";
$pageDesc     = "Buy premium quality Dates (Medjool, Kimia, Zahidi) in bulk. We supply soft, semi-dry, and dry dates. 100% natural, high energy, and sortex cleaned.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Dates Khajoor Premium" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Packed with natural sugars (glucose, fructose), providing an instant energy kick.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>We source Medjool, Kimia, and Zahidi varieties known for their superior taste and texture.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Natural</h4>
                                <p>No artificial sweeteners or preservatives. Naturally sun-dried or processed hygienically.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich in Fiber</h4>
                                <p>Excellent source of dietary fiber and essential minerals like Iron and Potassium.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX offers a premium selection of Dates (Khajoor), nature's perfect sweetener. From the soft and fleshy Medjool to the moist and dark Kimia, our dates are selected from the finest orchards. Whether used for direct consumption, baking, or processing into syrups and pastes, our dates guarantee freshness, high nutritional value, and an authentic sweet taste.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Medjool (King of Dates)</h4>
                            <ul>
                                <li><strong>Texture:</strong> Soft, fleshy, chewy.</li>
                                <li><strong>Size:</strong> Jumbo / Large.</li>
                                <li><strong>Taste:</strong> Caramel-like sweetness.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Kimia (Mazafati)</h4>
                            <ul>
                                <li><strong>Texture:</strong> Soft, wet, melts in mouth.</li>
                                <li><strong>Color:</strong> Dark Brown to Black.</li>
                                <li><strong>Use:</strong> Table fruit, Dessert.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Zahidi (Golden)</h4>
                            <ul>
                                <li><strong>Texture:</strong> Semi-dry, firm.</li>
                                <li><strong>Color:</strong> Golden Yellow.</li>
                                <li><strong>Use:</strong> Cooking, Processing.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Dry Dates (Chhuhara)</h4>
                            <ul>
                                <li><strong>Texture:</strong> Hard, dehydrated.</li>
                                <li><strong>Color:</strong> Yellow or Dark Brown.</li>
                                <li><strong>Use:</strong> Religious rituals, Powder.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Phoenix dactylifera</td></tr>
                        <tr><th>Moisture</th><td>15% - 25% (Depending on variety)</td></tr>
                        <tr><th>Total Sugar</th><td>60% - 70% (Natural)</td></tr>
                        <tr><th>Foreign Matter</th><td>Nil</td></tr>
                        <tr><th>Texture</th><td>Soft / Semi-Dry / Dry</td></tr>
                        <tr><th>Shelf Life</th><td>12 - 18 Months (Refrigerated)</td></tr>
                        <tr><th>Origin</th><td>Middle East / India</td></tr>
                        <tr><th>Packaging</th><td>5kg/10kg Cartons or 500g Packs</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Retail & Bulk</strong><br>We offer attractive window boxes (500g, 1kg) for retail and strong corrugated cartons (5kg, 10kg) for bulk wholesale.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Versatile</strong><br>Consumed raw, stuffed with nuts, used in smoothies, energy bars, desserts, or processed into Date Syrup/Sugar.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 18-20 Metric Tons<br><strong>Storage:</strong> Requires Cool/Dry or Refer<br><strong>Availability:</strong> Year-round</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you supply pitted dates?</span>
                        <span class="faq-a">Yes, we supply both pitted (seedless) and unpitted (with seed) dates depending on buyer requirements.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Which variety has the longest shelf life?</span>
                        <span class="faq-a">Dry dates (Chhuhara) and semi-dry varieties like Zahidi have longer shelf lives compared to soft varieties like Kimia.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Are your dates processed with syrup?</span>
                        <span class="faq-a">Our premium table dates are 100% natural with no added sugar or syrup. Processed industrial dates may have glazing if requested.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the ideal storage temperature?</span>
                        <span class="faq-a">Soft dates (Kimia/Medjool) are best stored between 0°C to 5°C. Dry dates can be stored at cool room temperature.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Dates (Khajoor)",
  "image": "https://theagroxgroup.org/assets/images/dates.avif",
  "description": "Premium Dates (Khajoor) Exporter from India. Varieties include Medjool, Kimia, Zahidi, and Dry Dates. 100% natural and sortex cleaned.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "DATES-PREM-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/dates-exporter-from-india.php",
    "priceCurrency": "USD",
