<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: KIDNEY BEANS (RAJMA)
// ----------------------------------------------------------------
$productName  = "Kidney Beans (Rajma)";
$categoryName = "PULSES & LENTILS";
$bannerText   = "RAJMA"; // Indian trade name
$imagePath    = "../assets/images/redkidney.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Kidney Beans (Rajma) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy premium Kidney Beans (Rajma) in bulk. We export Red Kidney Beans, Chitra (Speckled), and Jammu Rajma varieties. Sortex cleaned and high protein.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Red Kidney Beans Rajma Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich Texture</h4>
                                <p>Known for holding shape well while cooking, absorbing flavors for rich, thick gravy.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sourced from Jammu, Himachal, and Maharashtra. Offering Red, Chitra, and Sharmili types.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Machine processed to remove stones and damaged seeds, ensuring uniform size and purity.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Protein</h4>
                                <p>A powerhouse of plant-based protein, iron, and fiber. Essential for a balanced diet.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX offers the finest selection of Kidney Beans (Rajma) from India, famous worldwide for their superior taste and texture. Our Rajma is sourced from the cool climates of the Himalayas and the fertile plains of Maharashtra. Whether you need the dark red variety for salads and canning or the speckled (Chitra) variety for traditional curries, we deliver consistency in every bag.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            ...
                            <ul>
                                <li><strong>Color:</strong> Dark Red / Crimson.</li>
                                <li><strong>Shape:</strong> Kidney shaped, robust.</li>
                                <li><strong>Use:</strong> Salads, Chili Con Carne, Canning.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Chitra (Speckled)</h4>
                            <ul>
                                <li><strong>Color:</strong> White with Red spots.</li>
                                <li><strong>Taste:</strong> Mild, softer texture.</li>
                                <li><strong>Use:</strong> Curries, Indian Rajma Chawal.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Jammu Rajma (Small)</h4>
                            <ul>
                                <li><strong>Color:</strong> Glossy Red.</li>
                                <li><strong>Origin:</strong> Himalayan Region.</li>
                                <li><strong>Feature:</strong> Distinct aroma, fast cooking.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Sharmili Rajma</h4>
                            <ul>
                                <li><strong>Color:</strong> Light Red / Pinkish.</li>
                                <li><strong>Texture:</strong> Very soft, melts in mouth.</li>
                                <li><strong>Use:</strong> Premium restaurant dishes.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Phaseolus vulgaris</td></tr>
                        <tr><th>Purity</th><td>98% - 99% (Machine Cleaned)</td></tr>
                        <tr><th>Moisture</th><td>12% - 14% Maximum</td></tr>
                        <tr><th>Admixture</th><td>1% Maximum</td></tr>
                        <tr><th>Foreign Matter</th><td>0.5% Maximum</td></tr>
                        <tr><th>Imperfect Seeds</th><td>2% Maximum</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>PP & Jute</strong><br>We provide standard 25kg/50kg Polypropylene bags or traditional Jute bags. Consumer packs (500g, 1kg) available for private label.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Global Staple</strong><br>Essential for North Indian 'Rajma Masala', Mexican 'Refried Beans', and American Chili. Excellent canning stability.</p>
                    </div>
                    <div class="info-card">
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Which variety is best for canning?</span>
                        <span class="faq-a">Dark Red Kidney Beans are preferred for canning because they hold their shape and firm texture well after thermal processing.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer polished Rajma?</span>
                        <span class="faq-a">Yes, we offer both water-polished (for a clean shine) and oil-polished options, as well as natural unpolished beans.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">When stored in dry conditions below 20°C, our Kidney Beans have a shelf life of up to 24 months.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is fumigation done before shipping?</span>
                        <span class="faq-a">Yes, mandatory Methyl Bromide or Phosphine fumigation is conducted to ensure 100% pest-free cargo upon arrival.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/redkidney.jpg",
  "description": "Premium Kidney Beans (Rajma) Exporter from India. Varieties include Red, Chitra (Speckled), and Jammu Rajma. Sortex cleaned and machine polished.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "KIDNEY-RED-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/kidney-beans-exporter-from-india.php",
    "priceCurrency": "USD",
