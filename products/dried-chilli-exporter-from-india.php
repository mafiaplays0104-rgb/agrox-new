<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: DRIED RED CHILLI (WHOLE)
// ----------------------------------------------------------------
$productName  = "Dried Red Chilli (Whole)";
$categoryName = "WHOLE SPICES";
$bannerText   = "SPICY";
$imagePath    = "../assets/images/redchilliwh.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Dried Red Chilli Exporter India | Guntur S4, Teja S17, Byadgi | AGROX";
$pageDesc     = "Exporting premium Indian Dried Red Chillies. Sourcing Guntur Sannam S4, Teja S17, and Byadgi varieties. Available in Stemless and With Stem quality.";
        ...
        <div class="glass-wrapper">
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Dried Red Chilli Whole Guntur" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Guntur Origin</h4>
                                <p>Sourced from Andhra Pradesh, the largest and finest chilli market in Asia.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Pungency</h4>
                                <p>Rich in Capsaicin, providing intense heat and sharp flavor.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Stemless</h4>
                                <p>Machine-stemmed options available for pure spice grinding.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Sun Dried</h4>
                                <p>Naturally dried to preserve color (ASTA) and extend shelf life.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports India's famous Red Chillies, known globally for their vibrant red color and fiery heat. We source top varieties directly from Guntur (Andhra Pradesh) and Byadgi (Karnataka). Whether you need high heat (Teja) or high color (Byadgi), our chillies are graded, dried, and packed to meet international standards for food processing and oleoresin extraction.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Popular Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>S4 Sannam (Guntur)</h4>
                            <ul>
                                <li><strong>Heat:</strong> Medium-Hot (35k - 40k SHU)</li>
                                <li><strong>Color:</strong> Bright Red</li>
                                <li><strong>Use:</strong> General Cooking, Curry</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Teja (S17)</h4>
                            <ul>
                                <li><strong>Heat:</strong> Very Hot (75k - 100k SHU)</li>
                                <li><strong>Color:</strong> Deep Red</li>
                                <li><strong>Use:</strong> Oleoresin, Hot Sauce</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Byadgi (Kaddi)</h4>
                            <ul>
                                <li><strong>Heat:</strong> Mild (10k - 15k SHU)</li>
                                <li><strong>Color:</strong> High ASTA (Deep Red)</li>
                                <li><strong>Use:</strong> Color Extraction, Powder</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Kashmiri Chilli</h4>
                            <ul>
                                <li><strong>Heat:</strong> Mild</li>
                                <li><strong>Color:</strong> Vibrant Red</li>
                                <li><strong>Use:</strong> Tandoori, Marinades</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Pungency (SHU)</th><td>20,000 - 90,000 (Variety Specific)</td></tr>
                        <tr><th>Color (ASTA)</th><td>60 - 140 ASTA</td></tr>
                        <tr><th>Moisture</th><td>10% - 12% Max</td></tr>
                        <tr><th>Loose Seeds</th><td>3% Max</td></tr>
                        <tr><th>Foreign Matter</th><td>1% Max</td></tr>
                        <tr><th>Aflatoxin</th><td>B1+B2+G1+G2 < 10 PPB (EU Std)</td></tr>
                        <tr><th>Sudan Dyes</th><td>Absent</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        <h4>Pressed Bales</h4>
                        <p><strong>10kg / 25kg</strong><br>Compressed bales wrapped in Jute or PP. Most economical for bulk shipping as it maximizes container load.</p>
                    </div>
                    <div class="info-card">
                        <h4>Loose Bags</h4>
                        <p><strong>10kg / 25kg</strong><br>Non-compressed in Jute/Gunny bags. Preferred when preserving the whole shape of the chilli is critical.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 6 - 7 MT (Loose) / 14 MT (Pressed)<br><strong>40 FT:</strong> 13 MT (Loose) / 26 MT (Pressed)</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Oleoresin Extraction</h4>
                        <p>High-heat Teja and high-color Byadgi chillies are the primary raw material for extracting Capsaicin and Paprika Oleoresin.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Spices & Blends</h4>
                        <p>Grinding mills worldwide import our stemless chillies to produce pure Red Chilli Powder and Curry blends.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between S4 and S17?</span>
                        <span class="faq-a">S4 (Sannam) is the standard variety for cooking. S17 (Teja) is significantly hotter and widely used for extraction and industrial use.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Stem vs. Stemless?</span>
                        <span class="faq-a">Stemless chillies are cleaner and ready for grinding, offering better value by weight. Stem chillies are traditional and slightly cheaper per kg.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you check for Sudan Dyes?</span>
                        <span class="faq-a">Yes, every consignment is tested for Sudan I, II, III, and IV dyes to ensure compliance with EU and FDA regulations.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you mix varieties?</span>
                        <span class="faq-a">Yes, we can load different varieties (e.g., half Teja, half Byadgi) in the same container to suit your market needs.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/redchilliwh.avif",
  "description": "Export-grade Indian Dry Red Chilli. Guntur S4, Teja S17, and Byadgi varieties. Stemless and stem-cut available.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CHI-WH-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/dried-chilli-exporter-from-india.php",
    "priceCurrency": "USD",
