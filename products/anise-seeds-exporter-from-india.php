<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: STAR ANISE (CHAKRA PHOOL)
// ----------------------------------------------------------------
$productName  = "Star Anise (Chakra Phool)";
$categoryName = "WHOLE SPICES";
$bannerText   = "ILLICIUM VERUM"; // Scientific/Trade name
$imagePath    = "../assets/images/starsnise.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Star Anise (Chakra Phool) Exporter India | AGROX";
$pageDesc     = "Buy premium Star Anise (Chakra Phool) in bulk. We supply Hand-Picked Whole Flowers and Broken grades. High oil content, intense aroma, and export quality.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Star Anise Chakra Phool Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Exotic Aroma</h4>
                                <p>Famous for its strong, sweet, licorice-like flavor due to high Anethole content.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Premium Whole Flowers</h4>
                                <p>Hand-sorted to ensure mostly intact 8-point star shapes, perfect for premium retail.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>The primary source of Shikimic Acid, used in antiviral medications (Tamiflu).</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sourced from the evergreen forests of Arunachal Pradesh (India) and Vietnam.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports superior quality Star Anise (Chakra Phool), a beautiful star-shaped spice that is the cornerstone of Asian cuisine. Known for its distinct licorice flavor, our Star Anise is carefully harvested, sun-dried, and hand-sorted to preserve the integrity of the flower petals. We offer both whole flowers for aesthetic culinary use and broken pieces for grinding and extraction.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Whole Star Anise (Flower)</h4>
                            <ul>
                                <li><strong>Quality:</strong> Premium Hand Selected.</li>
                                <li><strong>Integrity:</strong> 80% - 90% Whole Stars.</li>
                                <li><strong>Use:</strong> Biryani, Garnish, Tea.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Broken Star Anise</h4>
                            <ul>
                                <li><strong>Quality:</strong> Standard / Grinding.</li>
                                <li><strong>Appearance:</strong> Clean broken segments.</li>
                                <li><strong>Use:</strong> Spice Powders (Garam Masala).</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Oil Grade</h4>
                            <ul>
                                <li><strong>Type:</strong> High volatile oil content.</li>
                                <li><strong>Use:</strong> Essential Oil Extraction.</li>
                                <li><strong>Feature:</strong> Cost-effective.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Autumn Crop</h4>
                            <ul>
                                <li><strong>Season:</strong> Harvested Sept-Oct.</li>
                                <li><strong>Feature:</strong> Larger pods, deeper color.</li>
                                <li><strong>Origin:</strong> India / Vietnam.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Illicium verum</td></tr>
                        <tr><th>Moisture</th><td>13.5% Maximum</td></tr>
                        <tr><th>Admixture</th><td>1% Maximum</td></tr>
                        <tr><th>Volatile Oil</th><td>Min 8% - 10%</td></tr>
                        <tr><th>Ash</th><td>4% Maximum</td></tr>
                        <tr><th>Broken Flowers</th><td>Max 5% (in Whole Grade)</td></tr>
                        <tr><th>Color</th><td>Reddish Brown</td></tr>
                        <tr><th>Packaging</th><td>10kg / 20kg Carton Box</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Fragile Care</strong><br>Packed in strong 5-ply corrugated carton boxes to prevent breakage of the delicate star arms during transit.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Flavor Bomb</strong><br>A key ingredient in Chinese Five-Spice powder, Vietnamese Pho soup, and Indian Masala Chai and Biryani.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 6-7 Metric Tons (Voluminous)<br><strong>40 FT Container:</strong> 14-15 Metric Tons<br><strong>Availability:</strong> Year-round</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the percentage of whole flowers?</span>
                        <span class="faq-a">For our premium grade, we guarantee a minimum of 80-90% whole stars. Standard grades may have a higher percentage of broken pieces.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your Star Anise adulterated?</span>
                        <span class="faq-a">Never. We strictly supply <i>Illicium verum</i> (True Star Anise) and ensure it is free from the toxic Japanese Star Anise (<i>Illicium anisatum</i>).</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Why is it packed in cartons instead of bags?</span>
                        <span class="faq-a">Star Anise is very lightweight and brittle. Carton boxes provide the necessary structural support to keep the flower shape intact.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply powder?</span>
                        <span class="faq-a">Yes, we can supply pure Star Anise Powder ground from clean broken pieces, packed in moisture-proof liners.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/staranise.avif",
  "description": "Premium Star Anise (Chakra Phool) Exporter from India. Hand-selected whole flowers with high oil content. Available in bulk.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "STAR-ANISE-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/star-anise-exporter-from-india.php",
    "priceCurrency": "USD",
