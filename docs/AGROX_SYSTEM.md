...
This document defines the core philosophy, visual design system, layout rhythms, and motion constants of the AGROX digital ecosystem. It is extracted directly from the production codebase and serves as a strict standard for all current and future page expansions.
