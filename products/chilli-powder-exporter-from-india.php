<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CHILLI POWDER
// ----------------------------------------------------------------
$productName  = "Chilli Powder (Lal Mirch)";
$categoryName = "POWDERED SPICES";
$bannerText   = "FIERY";
$imagePath    = "../assets/images/redchillipw.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Red Chilli Powder Exporter India | Guntur & Kashmiri Mirch | AGROX";
$pageDesc     = "Leading exporter of premium Red Chilli Powder from India. Sourcing high-heat Guntur and high-color Byadgi/Kashmiri chilli powder. Sudan Dye Free & Aflatoxin tested.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Red Chilli Powder Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Stemless</h4>
                                <p>Processed from stem-cut chillies to ensure pure powder without stalk impurities.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Vibrant Color</h4>
                                <p>High ASTA color values (60-140) for a natural, deep red appearance.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Cryo Ground</h4>
                                <p>Cold grinding technology preserves pungency (capsaicin) and natural oils.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Aflatoxin Free</h4>
                                <p>Lab-tested to ensure freedom from Aflatoxins and Sudan dyes.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports the finest Indian Red Chilli Powder, essential for adding heat and color to cuisines worldwide. We source premium dried chillies from Guntur (Andhra Pradesh) and Byadgi (Karnataka). Our manufacturing process involves meticulous cleaning, stem removal, and low-temperature grinding to deliver a powder that strikes the perfect balance between heat and vibrant red color.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Guntur (S4/S17)</h4>
                            <ul>
                                <li><strong>Heat:</strong> High (40k - 90k SHU)</li>
                                <li><strong>Color:</strong> Bright Red</li>
                                <li><strong>Use:</strong> Spicy Curries, Sauces</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Kashmiri / Byadgi</h4>
                            <ul>
                                <li><strong>Heat:</strong> Mild (10k - 20k SHU)</li>
                                <li><strong>Color:</strong> Deep Dark Red</li>
                                <li><strong>Use:</strong> Color Enhancement</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Reshampatti</h4>
                            <ul>
                                <li><strong>Heat:</strong> Medium (30k - 40k SHU)</li>
                                <li><strong>Color:</strong> Rich Red</li>
                                <li><strong>Use:</strong> Pickles, Seasonings</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Extra Hot</h4>
                            <ul>
                                <li><strong>Heat:</strong> Very High (>90k SHU)</li>
                                <li><strong>Source:</strong> Teja Variety</li>
                                <li><strong>Use:</strong> Pepper Sprays, Extracts</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Heat Value (SHU)</th><td>20,000 - 90,000 (As per variety)</td></tr>
                        <tr><th>Color Value (ASTA)</th><td>60 - 160 ASTA</td></tr>
                        <tr><th>Moisture</th><td>10% Max</td></tr>
                        <tr><th>Total Ash</th><td>8% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>1.3% Max</td></tr>
                        <tr><th>Sudan Dyes (I-IV)</th><td>Negative (Not Detected)</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>PP Woven Bags or Paper Bags with HDPE liner. Strong packaging to prevent color fading.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Jars</strong><br>Laminated pouches (100g to 1kg) with nitrogen flushing to maintain color stability.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 16 - 17 Metric Tons<br><strong>40 FT:</strong> 26 - 27 Metric Tons<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Sauces & Ketchups</h4>
                        <p>Provides the signature heat and red color to hot sauces, chili pastes, and ketchup.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Meat & Marinades</h4>
                        <p>Used in barbecue rubs, tandoori marinades, and sausage mixes for flavor depth.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is SHU and ASTA?</span>
                        <span class="faq-a">SHU (Scoville Heat Units) measures pungency/heat. ASTA measures color intensity. Higher ASTA means deeper red color.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your chilli powder free from Sudan Dyes?</span>
                        <span class="faq-a">Absolutely. Sudan dyes are carcinogenic additives. We rigorously test every batch to ensure they are 100% negative.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Which variety is best for color without heat?</span>
                        <span class="faq-a">Kashmiri or Byadgi varieties are excellent for rich red color with very mild heat.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you match a specific heat/color profile?</span>
                        <span class="faq-a">Yes, we can blend different chilli varieties to achieve your target SHU and ASTA specification.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/redchillipw.jpg",
  "description": "Export-grade Indian Red Chilli Powder. Guntur and Byadgi varieties. High heat and vibrant color options.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CHI-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/chilli-powder-exporter-from-india.php",
    "priceCurrency": "USD",
