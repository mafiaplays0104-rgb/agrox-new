<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CUMIN POWDER
// ----------------------------------------------------------------
$productName  = "Cumin Powder (Jeera)";
$categoryName = "POWDERED SPICES";
$bannerText   = "ROASTED";
$imagePath    = "../assets/images/cuminpw.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Cumin Powder (Jeera) Manufacturer & Exporter India | AGROX";
$pageDesc     = "Exporting high-quality Cumin Powder (Jeera Powder). Cold-ground to retain essential oils and aroma. Available in Roasted and Regular varieties in bulk.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Cumin Powder Jeera" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Cold Grinding</h4>
                                <p>Processed at low temperatures to retain volatile oils and natural aroma.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Pure</h4>
                                <p>Zero adulteration. Free from starch, artificial colors, or sawdust.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Roasted Flavor</h4>
                                <p>Available in 'Bhuna Jeera' variety for enhanced smoky flavor.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Aroma Lock</h4>
                                <p>Packaged immediately after grinding to lock in freshness.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX manufactures premium quality Cumin Powder (Jeera Powder) derived from the finest Gujarat cumin seeds. We utilize advanced "Cold Grinding Technology" (Cryogenic Grinding) which prevents the loss of essential oils during processing. The result is a powder with an intense earthy aroma and distinct flavor, perfect for curry blends and seasoning.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            ...
                            <ul>
                                <li><strong>Process:</strong> Sun Dried & Ground</li>
                                <li><strong>Color:</strong> Light Brown</li>
                                <li><strong>Use:</strong> Everyday Cooking, Masalas</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Roasted (Bhuna Jeera)</h4>
                            <ul>
                                <li><strong>Process:</strong> Roasted then Ground</li>
                                <li><strong>Color:</strong> Dark Brown</li>
                                <li><strong>Use:</strong> Chaat Masala, Raita, Beverages</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>IPM Grade</h4>
                            <ul>
                                <li><strong>Pesticide:</strong> Low/Pesticide Free</li>
                                <li><strong>Process:</strong> Steam Sterilized</li>
                                <li><strong>Use:</strong> EU/USA Exports</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Organic Grade</h4>
                            <ul>
                                <li><strong>Certification:</strong> USDA / NOP / EU</li>
                                <li><strong>Purity:</strong> 100% Organic</li>
                    ...
                    <table class="spec-table">
                        <tr><th>Volatile Oil</th><td>2.5% Min (Retained)</td></tr>
                        <tr><th>Total Ash</th><td>9% Max</td></tr>
                        <tr><th>Acid Insoluble Ash</th><td>1.5% Max</td></tr>
                        <tr><th>Moisture</th><td>9% Max</td></tr>
                        <tr><th>Mesh Size</th><td>60 - 80 Mesh (Fine Powder)</td></tr>
                        <tr><th>Salmonella / E.Coli</th><td>Absent</td></tr>
                        <tr><th>Flavor Profile</th><td>Warm, Earthy, Slightly Bitter</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>Paper Bags (Kraft) or PP Bags with inner liner to prevent caking and moisture absorption.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Jars</strong><br>50g, 100g, 500g laminated pouches. Private labeling available for supermarkets.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 17 - 18 Metric Tons<br><strong>40 FT:</strong> 27 - 28 Metric Tons<br><strong>Lead Time:</strong> 10-12 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Seasoning Manufacturers</h4>
                        <p>Essential ingredient in Taco Seasoning, Curry Powders, Garam Masala, and BBQ Rubs.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Snack Industry</h4>
                        <p>Used for flavoring chips, nachos, roasted nuts, and savory snacks.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Why is Cold Grinding important for Cumin?</span>
                        <span class="faq-a">Cumin has volatile oils that evaporate at high heat. Cold grinding ensures the machine doesn't heat up, preserving the full flavor.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you check for adulteration?</span>
                        <span class="faq-a">We perform microscopy and chemical tests to ensure zero presence of foreign starch or sawdust in our powder.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your Cumin Powder Sterilized?</span>
                        <span class="faq-a">Yes, we offer Steam Sterilized Cumin Powder to meet low microbial load requirements for export.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">12 to 18 months when stored in airtight packaging in cool, dry conditions.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/cuminpw.jpg",
  "description": "Export-grade Indian Cumin Powder (Jeera Powder). Cold ground, high aroma, zero adulteration.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CUM-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/cumin-powder-exporter-from-india.php",
    "priceCurrency": "USD",
