<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: TOOR DAL (PIGEON PEAS)
// ----------------------------------------------------------------
$productName  = "Toor Dal (Pigeon Peas)";
$categoryName = "PULSES & LENTILS";
$bannerText   = "ARHAR DAL"; // Indian trade name, widely recognized
$imagePath    = "../assets/images/toordal.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Toor Dal (Pigeon Peas) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy export-quality Toor Dal (Arhar Dal) in bulk. We supply Oily (Surati), Unpolished Desi, and Fatka quality Pigeon Peas. High protein and Sortex cleaned.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Toor Dal Arhar Dal Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Fatka Processed</h4>
                                <p>Processed using the traditional 'Fatka' method for premium texture and faster cooking.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Rich in dietary fiber and folic acid, making it easy to digest and heart-healthy.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Premium Polish</h4>
                                <p>Available in Oily (Surati) and Unpolished (Desi) varieties to suit regional preferences.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Sortex Quality</h4>
                                <p>Machine cleaned and laser sorted to remove stones, discoloration, and foreign matter.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the finest quality Toor Dal (Pigeon Peas), a staple in Indian cuisine essential for making aromatic Sambar and Dal Tadka. Sourced from the best farms in Maharashtra and Gujarat, our Toor Dal is processed to preserve its natural nutty flavor and nutritional integrity. We offer both the premium "Oily" variety (popular in Gujarat) and the "Unpolished" variety (preferred for its raw taste).
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Oily Toor Dal (Surati)</h4>
                            <ul>
                                <li><strong>Process:</strong> Treated with edible oil/water.</li>
                                <li><strong>Appearance:</strong> Shiny, Premium Yellow.</li>
                                <li><strong>Shelf Life:</strong> Extended longevity.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Desi Toor Dal (Unpolished)</h4>
                            <ul>
                                <li><strong>Process:</strong> No oil or water polish.</li>
                                <li><strong>Taste:</strong> Authentic, Rustic flavor.</li>
                                <li><strong>Nutrition:</strong> Higher fiber retention.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Lemon Toor Dal</h4>
                            <ul>
                                <li><strong>Origin:</strong> Processed from imported seeds.</li>
                                <li><strong>Color:</strong> Bright Lemon Yellow.</li>
                                <li><strong>Cost:</strong> Economical option.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Red Toor (Whole)</h4>
                            <ul>
                                <li><strong>Type:</strong> Whole Pigeon Pea with Skin.</li>
                                <li><strong>Use:</strong> Sprouting, Stews.</li>
                                <li><strong>Market:</strong> Specialty / Ethnic.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Cajanus cajan</td></tr>
                        <tr><th>Purity</th><td>99% (Sortex Cleaned)</td></tr>
                        <tr><th>Moisture</th><td>12% Maximum</td></tr>
                        <tr><th>Admixture</th><td>1% Maximum</td></tr>
                        <tr><th>Foreign Matter</th><td>0.25% Maximum</td></tr>
                        <tr><th>Weevilled Seeds</th><td>Nil</td></tr>
                        <tr><th>Polishing Agent</th><td>Edible Oil / Water (Optional)</td></tr>
                        <tr><th>Packaging</th><td>25kg / 50kg PP Bags</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>PP & Jute Bags</strong><br>We provide strong export-worthy PP bags to prevent moisture ingress. Customized consumer packs (1kg, 2kg, 5kg) are available for retail brands.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Staple Food</strong><br>The primary ingredient for Indian Sambar, Dal Tadka, and Varan. It thickens well and absorbs spices perfectly.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 24 Metric Tons<br><strong>Availability:</strong> Year-round<br><strong>Origin:</strong> India (Maharashtra/Gujarat)</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Oily and Unpolished Toor?</span>
                        <span class="faq-a">Oily Toor is treated with edible oil for shine and preservation (Surati style). Unpolished Toor has a matte finish and cooks faster with a more rustic taste.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is "Fatka" quality?</span>
                        <span class="faq-a">Fatka is a traditional processing method that ensures the grain splits naturally, resulting in a superior texture and preventing the dal from becoming mushy quickly.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Does Oily Toor Dal require washing?</span>
                        <span class="faq-a">Yes, Oily Toor Dal should be rinsed thoroughly with warm water before cooking to remove the excess oil coating.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your product free from artificial colors?</span>
                        <span class="faq-a">Absolutely. We guarantee zero artificial coloring (like Metanil Yellow). Our bright yellow color comes naturally from the specific seed variety (Lemon/Desi).</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/toordal.jpg",
  "description": "Premium Toor Dal (Arhar Dal) Exporter from India. Available in Oily Surati, Unpolished Desi, and Fatka grades. Sortex cleaned and high protein.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "TOOR-DAL-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/toor-dal-pigeon-peas-exporter-from-india.php",
    "priceCurrency": "USD",
