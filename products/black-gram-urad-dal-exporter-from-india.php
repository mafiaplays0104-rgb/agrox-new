<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: BLACK GRAM (URAD DAL)
// ----------------------------------------------------------------
$productName  = "Black Gram (Urad Dal)";
$categoryName = "PULSES & LENTILS";
$bannerText   = "BLACK MATPE"; // International trade name
$imagePath    = "../assets/images/urad.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Black Gram (Urad Dal) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy premium Black Gram (Black Matpe/Urad) in bulk. We supply Whole Black, Split Chilka, Urad Gota, and Split Washed varieties globally.";
    ...
    <div class="container">
        ...
        <div class="glass-wrapper">
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Black Gram Urad Dal Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Protein Powerhouse</h4>
                                <p>One of the richest sources of protein and Vitamin B among pulses.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Processed via advanced Sortex machines to ensure stone-free and uniform grains.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Fermentation King</h4>
                                <p>High mucilaginous content makes it the best choice for Idli/Dosa batters and Papads.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Sourced from the fertile black soils of Andhra Pradesh and Maharashtra.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports premium quality Black Gram (Urad Dal), also known globally as Black Matpe. This versatile lentil is a staple in Indian cuisine, essential for preparing batters, papads, and savory snacks. We offer both the whole bean (with black skin) and the deskinned/split varieties (white), ensuring purity, taste, and high nutritional value in every shipment.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Whole Black (Sabut)</h4>
                            <ul>
                                <li><strong>Type:</strong> Whole Bean with Skin</li>
                                <li><strong>Use:</strong> Dal Makhani, Stews</li>
                                <li><strong>Grade:</strong> FAQ & SQ Available</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Split Black (Chilka)</h4>
                            <ul>
                                <li><strong>Type:</strong> Split Bean with Skin</li>
                                <li><strong>Use:</strong> Traditional Dals</li>
                                <li><strong>Texture:</strong> Earthy flavor profile</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Urad Gota (Whole White)</h4>
                            <ul>
                                <li><strong>Type:</strong> Whole Bean Skin Removed</li>
                                <li><strong>Use:</strong> Idli/Dosa Batters, Sweets</li>
                                <li><strong>Quality:</strong> Premium Polish / Unpolished</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Urad Dal (Split White)</h4>
                            <ul>
                                <li><strong>Type:</strong> Split Bean Skin Removed</li>
                                <li><strong>Use:</strong> Everyday cooking, Tempering</li>
                                <li><strong>Features:</strong> Fast cooking, Creamy</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Vigna mungo</td></tr>
                        <tr><th>Origin</th><td>India (Maharashtra / Andhra)</td></tr>
                        <tr><th>Purity</th><td>98% - 99% (Machine Cleaned)</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        <h4>Processing Capability</h4>
                        <p><strong>Papad & Batter</strong><br>Our Urad Gota is specifically graded for the papad industry (high alkaloid content) and wet grinders for batter consistency.</p>
                    </div>
                    <div class="info-card">
                        <h4>Export Packaging</h4>
                        <p><strong>Custom Branding</strong><br>We offer 25kg, 50kg PP bags, and consumer packs (1kg, 2kg) with private labeling for supermarkets.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping</h4>
                        <p><strong>20 FT Container:</strong> 24 Metric Tons<br><strong>Availability:</strong> Year-round supply<br><strong>Lead Time:</strong> 15 Days</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between SQ and FAQ quality?</span>
                        <span class="faq-a">SQ (Sortex Quality) is machine cleaned and color-sorted for premium retail. FAQ (Fair Average Quality) is standard machine cleaned, suitable for milling or bulk food service.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you supply Urad Gota for Papad manufacturing?</span>
                        <span class="faq-a">Yes, we supply specific varieties of Urad Gota that have high yield and elasticity, which are critical for papad manufacturing.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your Urad Dal polished?</span>
                        <span class="faq-a">We supply both Water Polished (Silky) and Oil Polished varieties based on the buyer's requirement, as well as unpolished natural grains.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you provide Phyto and Fumigation certificates?</span>
                        <span class="faq-a">Yes, all export shipments come with mandatory Phytosanitary certificates and Fumigation reports ensuring pest-free cargo.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/urad.jpg",
  "description": "Buy premium Black Gram (Urad Dal/Black Matpe) from AGROX. Available in Whole, Split, and Gota varieties. High protein, Sortex cleaned.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "URAD-DAL-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/black-gram-urad-dal-exporter-from-india.php",
    "priceCurrency": "USD",
