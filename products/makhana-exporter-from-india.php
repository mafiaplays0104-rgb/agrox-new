<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: MAKHANA (FOX NUTS)
// ----------------------------------------------------------------
$productName  = "Makhana (Fox Nuts)";
$categoryName = "SUPERFOODS & NUTS";
$bannerText   = "LOTUS SEEDS"; // Trade name
$imagePath    = "../assets/images/makhana.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Phool Makhana (Fox Nuts) Exporter India | AGROX";
$pageDesc     = "Buy premium Makhana (Lotus Seeds) in bulk. We export 6 Sut (Jumbo) and 5 Sut (Bold) grades sourced from Bihar. High protein, gluten-free superfood.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Makhana Fox Nuts Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Mithila Origin</h4>
                                <p>Sourced directly from the ponds of Bihar (Mithila region), the GI-tagged heartland of Makhana.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Graded Perfection</h4>
                                <p>Available in 6 Sut (Jumbo) and 5 Sut (Bold) sizes. Hand-picked for roundness and whiteness.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Low Calorie Superfood</h4>
                                <p>High in protein and fiber, low in fat. Gluten-free and ideal for healthy snacking.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Natural Crunch</h4>
                                <p>Popped naturally without chemicals. Low moisture content ensures lasting crispness.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you premium Phool Makhana (Fox Nuts/Lotus Seeds), the ancient superfood of India. Our Makhana is cultivated in the wetlands of North Bihar, ensuring authentic taste and superior nutritional value. We specialize in exporting high-grade, machine-cleaned, and hand-sorted Makhana that is perfect for roasting, flavored snacks, or traditional curries.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>6 Sut+ (Platinum / Jumbo)</h4>
                            <ul>
                                <li><strong>Size:</strong> > 19mm diameter.</li>
                                <li><strong>Appearance:</strong> Large, Round, White.</li>
                                <li><strong>Use:</strong> Premium Retail Packs, Gifting.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>5 Sut+ (Gold / Bold)</h4>
                            <ul>
                                <li><strong>Size:</strong> 15mm - 18mm diameter.</li>
                                <li><strong>Appearance:</strong> Standard Round.</li>
                                <li><strong>Use:</strong> Snacking, Export Standard.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>4 Sut (Silver / Medium)</h4>
                            <ul>
                                <li><strong>Size:</strong> 12mm - 14mm diameter.</li>
                                <li><strong>Texture:</strong> Slightly harder.</li>
                                <li><strong>Use:</strong> Food Processing, Flour.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Hand Picked Quality</h4>
                            <ul>
                                <li><strong>Process:</strong> Manually sorted.</li>
                                <li><strong>Quality:</strong> Removes black spots/shells.</li>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Euryale ferox</td></tr>
                        <tr><th>Origin</th><td>Bihar, India (Mithila)</td></tr>
                        <tr><th>Moisture</th><td>5% Maximum (for crunch)</td></tr>
                        <tr><th>Grade</th><td>5 Sut / 6 Sut</td></tr>
                        <tr><th>Foreign Matter</th><td>0.5% Maximum</td></tr>
                        <tr><th>Color</th><td>Natural White / Off-white</td></tr>
                        <tr><th>Shelf Life</th><td>12 Months (Dry Storage)</td></tr>
                        <tr><th>Packaging</th><td>8kg/10kg Bulk Bags or Vacuum Packs</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Volume Based</strong><br>Makhana is light & voluminous. We pack in high-quality gunny bags or HDPE bags. Vacuum packing available to save volume.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Snack & Curry</strong><br>Roasted with ghee/spices as a healthy snack, or used in rich gravies (Makhana Curry) and deserts (Kheer/Pudding).</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>40 FT HC Container:</strong> Approx 8-9 Metric Tons<br><strong>Availability:</strong> Year-round<br><strong>Lead Time:</strong> 10-15 Days</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is "Sut" in Makhana grading?</span>
                        <span class="faq-a">"Sut" is a traditional unit of measurement used in the trade to denote the diameter size of the popped kernel. Higher Sut means larger size.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is your Makhana roasted or raw?</span>
                        <span class="faq-a">We supply "Phool Makhana" which is the popped raw kernel. It needs to be roasted or cooked before consumption for best taste.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Why is Makhana considered a superfood?</span>
                        <span class="faq-a">It is low in calories, low in sodium, gluten-free, and has a low glycemic index, making it ideal for diabetics and weight watchers.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you vacuum pack to reduce freight cost?</span>
                        <span class="faq-a">Yes, vacuum packing compresses the product slightly and protects it from moisture, allowing more quantity per container.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/makhana.avif",
  "description": "Premium Phool Makhana (Lotus Seeds) Exporter from India. Available in 5 Sut and 6 Sut grades. Sourced from Bihar.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "MAKHANA-5SUT-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/makhana-exporter-from-india.php",
    "priceCurrency": "USD",
