<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: WALNUTS (AKHROT)
// ----------------------------------------------------------------
$productName  = "Walnuts (Akhrot)";
$categoryName = "DRY FRUITS & NUTS";
$bannerText   = "OMEGA RICH"; // Trade nickname / Key benefit
$imagePath    = "../assets/images/walnut.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Walnuts (Akhrot) Kernels Exporter India | AGROX";
$pageDesc     = "Buy premium Walnut Kernels (Akhrot Giri) in bulk. We supply Kashmiri and Snow White varieties. High Omega-3, vacuum packed, and graded (ELH/LH).";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Walnuts Akhrot Kernels Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Brain Health</h4>
                                <p>Rich in Omega-3 (ALA), walnuts are known as the ultimate "Brain Food" for cognitive function.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Premium Grading</h4>
                                <p>Strictly graded into Extra Light Halves (ELH), Light Halves (LH), and Quarters for uniformity.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Vacuum Packed</h4>
                                <p>Packed in nitrogen-flushed vacuum bags to prevent oxidation and ensure fresh, crunchy kernels.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Sweet Kashmiri</h4>
                                <p>We offer authentic Kashmiri Walnuts, famous for their superior oil content and sweeter taste.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the finest Walnuts (Akhrot) sourced from the pristine valleys of Kashmir and premium international orchards. Our walnuts are celebrated for their rich, buttery flavor and high Omega-3 content. We process both Inshell Walnuts and Walnut Kernels, ensuring they are free from bitterness and shells. Perfect for snacking, baking, or confectionery.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Kashmiri Walnuts</h4>
                            <ul>
                                <li><strong>Flavor:</strong> Naturally sweet & oily.</li>
                                <li><strong>Shell:</strong> Hard / Semi-soft.</li>
                                <li><strong>Quality:</strong> Organic, Indigenous.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Extra Light Halves (ELH)</h4>
                            <ul>
                                <li><strong>Color:</strong> Pale ivory / white.</li>
                                <li><strong>Shape:</strong> 90% Intact halves.</li>
                                <li><strong>Use:</strong> Premium garnish, Gifts.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Light Halves (LH)</h4>
                            <ul>
                                <li><strong>Color:</strong> Light amber / golden.</li>
                                <li><strong>Shape:</strong> Mixed halves & large pieces.</li>
                                <li><strong>Use:</strong> Bakery, Chocolate coating.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Inshell Walnuts (Paper)</h4>
                            <ul>
                                <li><strong>Type:</strong> Kagzi (Paper Shell).</li>
                                <li><strong>Crackability:</strong> Easy hand-crack.</li>
                                <li><strong>Size:</strong> 30mm+ / 32mm+.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Juglans regia</td></tr>
                        <tr><th>Moisture</th><td>5% Maximum</td></tr>
                        <tr><th>Purity</th><td>99.9% (Shell-free kernels)</td></tr>
                        <tr><th>Color</th><td>Extra Light / Light Amber</td></tr>
                        <tr><th>Halves Content</th><td>Min 80% (For Halves Grade)</td></tr>
                        <tr><th>Rancidity</th><td>Negative</td></tr>
                        <tr><th>Origin</th><td>India (Kashmir) / USA / Chile</td></tr>
                        <tr><th>Packaging</th><td>5kg / 10kg Vacuum Bags</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Vacuum Technology</strong><br>Walnuts are highly susceptible to rancidity. We strictly use 5kg x 2 Vacuum Packs in a 10kg master carton to guarantee shelf life.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Baking & Snacking</strong><br>Essential for brownies, cakes, salads, and trail mixes. Also pressed for high-quality cold-pressed Walnut Oil.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> Approx. 14-15 Metric Tons<br><strong>Storage:</strong> Refrigerated (0-4°C) Recommended<br><strong>Availability:</strong> Year-round</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Why are Kashmiri walnuts prized?</span>
                        <span class="faq-a">Kashmiri walnuts are organic by nature and have a higher oil content and sweeter taste compared to mass-produced varieties, though they may vary in shape.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between ELH and LH?</span>
                        <span class="faq-a">ELH (Extra Light Halves) are very pale/white and premium. LH (Light Halves) are slightly golden/amber. The nutritional value is identical; the difference is aesthetic.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you sell broken walnuts?</span>
                        <span class="faq-a">Yes, we supply Walnut Quarters and Broken pieces (Light Amber color) specifically for the bakery and confectionery industry at economical rates.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you prevent bitterness?</span>
                        <span class="faq-a">Bitterness comes from oxidation (rancidity). Our nitrogen-flushed vacuum packaging prevents air contact, keeping the natural oils fresh.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Walnuts (Akhrot)",
  "image": "https://theagroxgroup.org/assets/images/walnut.jpg",
  "description": "Premium Walnut Kernels (Akhrot) Exporter. Available in Kashmiri, Extra Light Halves, and Light Halves. Vacuum packed for freshness.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "WALNUT-ELH-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/walnuts-exporter-from-india.php",
    "priceCurrency": "USD",
