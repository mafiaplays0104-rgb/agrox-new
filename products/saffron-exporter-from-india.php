<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: SAFFRON (KESAR)
// ----------------------------------------------------------------
$productName  = "Kashmiri Saffron (Kesar)";
$categoryName = "PREMIUM SPICES";
$bannerText   = "RED GOLD";
$imagePath    = "../assets/images/saffron.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Kashmiri Saffron (Kesar) Exporter India | Mongra & Lacha Grade | AGROX";
$pageDesc     = "Exporting the world's finest Kashmiri Saffron (Kesar). 100% Pure Mongra and Lacha grades. High Crocin content, deep red stigmas, and intense aroma.";
        ...
        <div class="glass-wrapper">
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Kashmiri Saffron Kesar Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Kashmir Origin</h4>
                                <p>Grown in the legendary fields of Pampore, Kashmir. GI Tag Certified.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Deep Red Stigmas</h4>
                                <p>Rich in Crocin (>150), ensuring potent coloring strength and flavor.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Hand Harvested</h4>
                                <p>Each flower is delicately hand-picked at dawn to preserve freshness.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Pure</h4>
                                <p>Guaranteed adulteration-free. Tested for artificial dyes and weight fillers.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports the rarest and most precious spice in the world – Kashmiri Saffron (Kesar/Zafran). Cultivated in the high-altitude valleys of Pampore, our saffron is distinguished by its dark maroon-purple hue and intense aroma. We specialize in the "Mongra" grade, consisting of only the purest red stigmas, renowned worldwide as "Red Gold" for its culinary and medicinal potency.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Mongra (Premium)</h4>
                            <ul>
                                <li><strong>Part:</strong> Pure Red Stigmas</li>
                                <li><strong>Quality:</strong> Highest Potency</li>
                                <li><strong>Use:</strong> Gourmet, Gifts</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Lacha (Traditional)</h4>
                            <ul>
                                <li><strong>Part:</strong> Red Stigma + Yellow Tail</li>
                                <li><strong>Quality:</strong> Authentic Look</li>
                                <li><strong>Use:</strong> Daily Consumption</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Zarda</h4>
                            <ul>
                                <li><strong>Part:</strong> Yellow Tail parts</li>
                                <li><strong>Feature:</strong> High Aroma, Less Color</li>
                                <li><strong>Use:</strong> Perfumery, Tobacco</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Super Negin</h4>
                            <ul>
                                <li><strong>Style:</strong> Long, straight stigmas</li>
                                <li><strong>Market:</strong> Export / Middle East</li>
                                <li><strong>Use:</strong> Aesthetic Garnish</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Crocus sativus</td></tr>
                        <tr><th>Crocin (Color)</th><td>> 150 (ISO 3632 Category I)</td></tr>
                        <tr><th>Safranal (Aroma)</th><td>> 20</td></tr>
                        <tr><th>Picrocrocin (Flavor)</th><td>> 70</td></tr>
                        <tr><th>Moisture</th><td>10% Max</td></tr>
                        <tr><th>Foreign Matter</th><td>0.1% Max</td></tr>
                        <tr><th>Origin</th><td>Pampore, Kashmir (India)</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        <h4>Retail Packs</h4>
                        <p><strong>1g / 5g / 10g</strong><br>Airtight blisters, decorative metal tins, or glass jars to preserve the delicate aroma and protect from light.</p>
                    </div>
                    <div class="info-card">
                        <h4>Bulk Packaging</h4>
                        <p><strong>100g / 500g</strong><br>Food-grade metal containers or vacuum-sealed bags for industrial buyers and wholesalers.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping</h4>
                        <p><strong>Air Freight Only</strong><br>Due to high value and sensitivity, saffron is shipped exclusively via secure air cargo.</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Luxury Confectionery</h4>
                        <p>A key ingredient in premium sweets (Mithai), ice creams, and chocolates for distinct flavor and color.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Pharmaceuticals</h4>
                        <p>Utilized in Ayurvedic medicines and supplements for mental health, skin care, and antioxidant properties.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: How to distinguish real saffron?</span>
                        <span class="faq-a">Real saffron releases a golden-yellow color slowly in water but the thread remains red. It smells sweet but tastes slightly bitter.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Why is Kashmiri Saffron expensive?</span>
                        <span class="faq-a">It takes ~150,000 flowers to produce 1kg of saffron. It has the highest Crocin content compared to Iranian or Spanish varieties.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Is it certified?</span>
                        <span class="faq-a">Yes, our saffron comes with a GI (Geographical Indication) tag and lab reports confirming ISO 3632 standards.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">2 to 3 years if stored in an airtight container in a cool, dark place away from moisture.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/saffron.avif",
  "description": "Export-grade Kashmiri Saffron. Premium Mongra and Lacha grades. GI Tagged, high Crocin content.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "SAF-KSH-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/saffron-exporter-from-india.php",
    "priceCurrency": "USD",
