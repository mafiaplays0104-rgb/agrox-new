<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: DRIED FIGS (ANJEER)
// ----------------------------------------------------------------
$productName  = "Dried Figs (Anjeer)";
$categoryName = "DRY FRUITS & NUTS";
$bannerText   = "FICUS CARICA"; // Scientific Name
$imagePath    = "../assets/images/figs.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Dried Figs (Anjeer) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy premium Dried Figs (Anjeer) in bulk. We supply naturally sun-dried, chemical-free figs. Available in Rope and Pressed packings. High fiber and iron.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Dried Figs Anjeer Premium Export" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>One of the highest sources of natural dietary fiber, aiding digestion and gut health.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Naturally Sun-Dried</h4>
                                <p>Processed traditionally under the sun without sulfur or artificial preservatives.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Iron & Calcium</h4>
                                <p>Rich in essential minerals, making it a perfect natural supplement for bone strength.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Premium Varieties</h4>
                                <p>We offer light-skinned Lerida and smaller, sweeter Zahedi figs for diverse culinary uses.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the finest quality Dried Figs (Anjeer), cherished for their unique chewy texture and sweet, honey-like flavor. Sourced from the best orchards in Afghanistan and Turkey, our figs are allowed to dry naturally on the tree or under the sun. They are then carefully sorted, washed, and packed to ensure a wholesome, nutritious snack that is free from impurities.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Lerida (Flattened)</h4>
                            <ul>
                                <li><strong>Shape:</strong> Round, flattened discs.</li>
                                <li><strong>Color:</strong> Light brown / beige.</li>
                                <li><strong>Use:</strong> Premium retail, Gifting.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Rope Figs (Garland)</h4>
                            <ul>
                                <li><strong>Packaging:</strong> Threaded in loops.</li>
                                <li><strong>Size:</strong> Medium to Large.</li>
                                <li><strong>Use:</strong> Traditional markets, Wholesale.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Pulled Figs (Protoben)</h4>
                            <ul>
                                <li><strong>Shape:</strong> Elongated, pulled shape.</li>
                                <li><strong>Quality:</strong> Premium export grade.</li>
                                <li><strong>Use:</strong> High-end confectionery.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Natural / Industrial</h4>
                            <ul>
                                <li><strong>Shape:</strong> Irregular / diced.</li>
                                <li><strong>Texture:</strong> Harder, concentrated.</li>
                                <li><strong>Use:</strong> Paste, Jam, Chopped mix.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Ficus carica</td></tr>
                        <tr><th>Moisture</th><td>20% - 24% Maximum</td></tr>
                        <tr><th>Size</th><td>No. 1 to No. 8 (Based on diameter)</td></tr>
                        <tr><th>Foreign Matter</th><td>0.5% Maximum</td></tr>
                        <tr><th>Sugar Content</th><td>50% - 60% (Natural Fructose)</td></tr>
                        <tr><th>Origin</th><td>Afghanistan / Turkey / Iran</td></tr>
                        <tr><th>Packaging</th><td>5kg / 10kg Cartons (Bulk)</td></tr>
                        <tr><th>Shelf Life</th><td>12 Months (Cool Dry Place)</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Pressed & Loose</strong><br>Lerida figs are hand-pressed into patterns for aesthetic appeal in 1kg/5kg boxes. Loose figs are packed in bulk 10kg cartons.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Sweet & Savory</strong><br>Consumed as a healthy snack (soaked overnight), or used in jams, chutneys, energy bars, and bakery fillings.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> Approx. 18 Metric Tons<br><strong>Storage:</strong> 4°C - 10°C (Refrigerated)<br><strong>Availability:</strong> New Crop (Sept-Oct)</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: Why are some figs white powder coated?</span>
                        <span class="faq-a">This is often natural sugar crystallization (sugaring) that occurs over time. In some cases, rice flour is used to prevent sticking, which is industry standard.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How should dried figs be stored?</span>
                        <span class="faq-a">They should be stored in a cool, dry place, preferably refrigerated (0-4°C) to maintain color and prevent fermentation.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you treat figs with chemicals?</span>
                        <span class="faq-a">Our premium natural figs are untreated. However, for certain export markets requiring longer shelf life, we can supply sulfur-treated figs upon request.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Rope and Loose figs?</span>
                        <span class="faq-a">"Rope" figs are threaded onto a string (traditional garland style), often slightly harder. "Loose" figs (Lerida) are individually sorted, softer, and hand-packed.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/figs.avif",
  "description": "Premium Dried Figs (Anjeer) Exporter from India. Available in Lerida, Rope, and Pressed forms. 100% natural and high fiber.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "FIGS-LERIDA-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/figs-exporter-from-india.php",
    "priceCurrency": "USD",
