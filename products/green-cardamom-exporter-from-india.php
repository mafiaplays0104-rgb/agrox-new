<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: GREEN CARDAMOM (ELAICHI)
// ----------------------------------------------------------------
$productName  = "Green Cardamom (Elaichi)";
$categoryName = "WHOLE SPICES";
$bannerText   = "QUEEN OF SPICES"; // Trade nickname
$imagePath    = "../assets/images/cardamomwh.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Green Cardamom (8mm, 7mm) Exporter India | AGROX";
$pageDesc     = "Buy export-quality Green Cardamom (Alleppey Green) in bulk. Available in 8mm (Bold), 7mm, and 6mm grades. Intense aroma and deep green color.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Green Cardamom Alleppey Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Alleppey Green</h4>
                                <p>Sourced from the high ranges of Idukki, Kerala. Known globally for its deep green color and high oil content.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Intense Aroma</h4>
                                <p>Rich in volatile oils (Terpinyl Acetate & Cineole) which give it a potent, refreshing fragrance.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            <div class="anchor-dot"></div>
                            <div class="benefit-box">
                                <h4>Graded Excellence</h4>
                                <p>Strictly graded by diameter: 8mm (Jumbo), 7mm (Extra Bold), and 6mm varieties available.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Hand Picked</h4>
                                <p>Carefully harvested and kiln-dried to preserve the natural green pigment and flavor profile.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX brings you the "Queen of Spices" directly from the lush plantations of Kerala, India. Our Green Cardamom (Alleppey Green) is renowned for its vibrant green color, full pods, and intensely aromatic seeds. Unlike lesser varieties, our cardamom retains its volatile oils due to careful processing and high-barrier packaging, making it the preferred choice for premium culinary and pharmaceutical applications worldwide.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Export Grades</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>8mm+ (Jumbo / AGEB)</h4>
                            <ul>
                                <li><strong>Size:</strong> > 8mm diameter.</li>
                                <li><strong>Color:</strong> Deep Parrot Green.</li>
                                <li><strong>Use:</strong> Premium Retail, Gifting.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>7mm - 8mm (Extra Bold)</h4>
                            <ul>
                                <li><strong>Size:</strong> 7mm to 8mm.</li>
                                <li><strong>Quality:</strong> Standard Export Grade.</li>
                                <li><strong>Use:</strong> Culinary, Restaurants.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>6mm - 7mm (Medium)</h4>
                            <ul>
                                <li><strong>Size:</strong> 6mm to 7mm.</li>
                                <li><strong>Appearance:</strong> Mixed Green/Pale.</li>
                                <li><strong>Use:</strong> Grinding, Masala Mixes.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Cardamom Seeds</h4>
                            <ul>
                                <li><strong>Form:</strong> Black seeds (husk removed).</li>
                                <li><strong>Purity:</strong> 99% Clean.</li>
                                <li><strong>Use:</strong> Baking, Confectionery.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Elettaria cardamomum</td></tr>
                        <tr><th>Variety</th><td>Alleppey Green (AG)</td></tr>
                        <tr><th>Moisture</th><td>10% - 11% Maximum</td></tr>
                        <tr><th>Litre Weight</th><td>Min 380 - 420 Gms/Litre</td></tr>
                        <tr><th>Volatile Oil</th><td>3% - 5%</td></tr>
                        <tr><th>Immature Pods</th><td>Max 5%</td></tr>
                        <tr><th>Thrips/Insect Marks</th><td>Nil / Minimal</td></tr>
                        <tr><th>Packaging</th><td>1kg/5kg Vacuum Packs in Master Carton</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Color Retention</strong><br>We use multi-layer vacuum bags or black polythene-lined jute bags to protect the green color from fading due to light exposure.</p>
                    </div>
                    <div class="info-card">
                        <h4>Culinary Uses</h4>
                        <p><strong>Sweet & Savory</strong><br>Essential for Biryanis, Chai (Tea), Curries, and Scandinavian baking. Also used as a natural breath freshener.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> Approx. 10-12 Metric Tons<br><strong>Storage:</strong> Cool, dark, dry place<br><strong>Availability:</strong> Year-round</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is Alleppey Green (AG)?</span>
                        <span class="faq-a">Alleppey Green is a specific grade of cardamom from Kerala, India, famous for having a higher volatile oil content and greener color than varieties from other origins (like Guatemala).</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you use artificial color?</span>
                        <span class="faq-a">Absolutely not. Our cardamom is 100% natural. The deep green color is preserved through controlled drying processes, not chemical dyes.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How is grading done?</span>
                        <span class="faq-a">Grading is done purely by the diameter of the pod using sieve holes (e.g., 8mm holes for Jumbo grade).</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply bleached cardamom?</span>
                        <span class="faq-a">Our focus is on premium Green Cardamom, but we can arrange for Bleached (White) Cardamom upon specific bulk request.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/cardamomwh.avif",
  "description": "Premium Alleppey Green Cardamom Exporter from India. Available in 8mm, 7mm, and 6mm grades. High volatile oil content.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CARDAMOM-8MM-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/green-cardamom-exporter-from-india.php",
    "priceCurrency": "USD",
