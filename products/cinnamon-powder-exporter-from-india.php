<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: CINNAMON POWDER
// ----------------------------------------------------------------
$productName  = "Cinnamon Powder (Dalchini)";
$categoryName = "POWDERED SPICES";
$bannerText   = "AROMATIC";
$imagePath    = "../assets/images/cinnamonpw.jpg"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Cinnamon Powder (Dalchini) Exporter India | Cassia & Ceylon | AGROX";
$pageDesc     = "Leading exporter of high-quality Cinnamon Powder from India. We supply premium Cassia and Ceylon cinnamon powder with high volatile oil content and rich aroma.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Pure Cinnamon Powder Export Quality" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Rich Aroma</h4>
                                <p>High volatile oil content provides a sweet, woody fragrance.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Premium Grade</h4>
                                <p>Sourced from Kerala and Meghalaya, ensuring top-tier quality.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Cold Ground</h4>
                                <p>Milled at low temperatures to preserve delicate essential oils.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>100% Pure</h4>
                                <p>Free from additives, colors, or cheap cassia adulteration.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports high-quality Cinnamon Powder (Dalchini), derived from selected bark of the Cinnamomum tree. Known for its sweet, warm taste and intense aroma, our cinnamon powder is a staple in baking, curries, and beverages. We offer both Cassia and Ceylon varieties, processed hygienically to meet international food safety standards.
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Cassia Powder</h4>
                            <ul>
                                <li><strong>Flavor:</strong> Strong & Spicy</li>
                                <li><strong>Color:</strong> Dark Reddish-Brown</li>
                                <li><strong>Use:</strong> Curries, Baking</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Ceylon Powder</h4>
                            <ul>
                                <li><strong>Flavor:</strong> Delicate & Sweet</li>
                                <li><strong>Color:</strong> Tan / Light Brown</li>
                                <li><strong>Use:</strong> Desserts, Beverages</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>High Oil Grade</h4>
                            <ul>
                                <li><strong>Oil Content:</strong> > 2.5%</li>
                                <li><strong>Process:</strong> Cryogenic Grinding</li>
                    ...
                    <table class="spec-table">
                        <tr><th>Volatile Oil</th><td>1% - 3%</td></tr>
                        ...
                        <tr><th>Coumarin Content</th><td>Low (Ceylon) / Standard (Cassia)</td></tr>
                    </table>
                </div>
            </div> 
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>25kg / 50kg</strong><br>Paper Bags or PP Bags with inner poly liner to prevent moisture absorption and aroma loss.</p>
                    </div>
                    <div class="info-card">
                        <h4>Retail Packaging</h4>
                        <p><strong>Pouches / Jars</strong><br>100g, 250g, 500g options. Private labeling services available for retail brands.</p>
                    </div>
                    <div class="info-card">
                        <h4>Container Capacity</h4>
                        <p><strong>20 FT:</strong> 14 - 15 Metric Tons<br><strong>40 FT:</strong> 25 - 26 Metric Tons<br><strong>Lead Time:</strong> 15-20 Days</p>
                    </div>
                </div>
                ...
                <div class="grid-2-col">
                    <div class="variety-card">
                        <h4>Baking Industry</h4>
                        <p>Essential for cinnamon rolls, cakes, cookies, and pastries for a warm, sweet spice profile.</p>
                    </div>
                    <div class="variety-card">
                        <h4>Beverages & Tea</h4>
                        <p>Used in Masala Chai blends, coffee flavorings, and health drinks for flavor and immunity benefits.</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the difference between Cassia and Ceylon?</span>
                        <span class="faq-a">Cassia is stronger, darker, and cheaper, used in savory dishes. Ceylon is milder, lighter, "True Cinnamon," used in sweets.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: What is the shelf life?</span>
                        <span class="faq-a">24 months when stored in airtight containers in a cool, dry place away from sunlight.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you provide sterilized powder?</span>
                        <span class="faq-a">Yes, we offer steam sterilized cinnamon powder to ensure low microbial counts for export.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you ship mixed containers?</span>
                        <span class="faq-a">Yes, we can combine Cinnamon with other spices like Cardamom, Clove, and Ginger powder.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/cinnamonpw.jpg",
  "description": "Export-grade Indian Cinnamon Powder. Cassia and Ceylon varieties available. Cold ground, high aroma.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "CIN-PW-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/cinnamon-powder-exporter-from-india.php",
    "priceCurrency": "USD",
