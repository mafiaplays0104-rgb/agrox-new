<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: INDUSTRIES HUB
// ----------------------------------------------------------------
$pageTitle = "Industry Applications Hub | B2B Agricultural Ingredients";
$metaDescription = "Explore the industries we serve. Supplying premium organic agricultural ingredients to food manufacturers, retail brands, spice blenders, and pharmaceutical producers.";
...
<div class="banner-wrapper" id="bannerContainer">
    <img src="../assets/images/bannerproduct.avif" alt="Industries Banner" class="banner-img-responsive">
    <div class="banner-scroll-text" id="bgText">INDUSTRIES</div>
    <h1 class="banner-title" id="fgText">SECTOR HUB</h1> 
...
<section id="main-content">
    <div class="container">
        ...
        <div class="placeholder-card">
            ...
            <p>We are currently designing custom industry matrices mapping our spice, oil, and dry fruit grades to their specific applications in commercial food processing, cosmetic formulations, and packaging. This sector directory will launch soon.</p>
            <a href="../contact-us.php?type=quote" class="btn-gold">REQUEST SECTOR COMPLIANCE MATRICES</a>
        </div>
