<?php 
// ----------------------------------------------------------------
//  PAGE CONFIGURATION: RED LENTILS (MASOOR DAL)
// ----------------------------------------------------------------
$productName  = "Red Lentils (Masoor Dal)";
$categoryName = "PULSES & LENTILS";
$bannerText   = "CRIMSON"; // Text scrolling behind the title
$imagePath    = "../assets/images/redlentis.avif"; 
$bgImage      = "../assets/images/Web.avif"; 

// SEO META DATA
$pageTitle    = "Premium Red Lentils (Masoor Dal) Exporter & Supplier India | AGROX";
$pageDesc     = "Buy high-quality Red Lentils (Masoor Dal) in bulk. We export Whole Red, Split Red, and Football varieties. Sortex cleaned and polished.";
            ...
            <div class="single-product-grid">
                ...
                <div class="left-col">
                    <div class="sp-image-box">
                        <img src="<?php echo $imagePath; ?>" alt="Red Lentils Masoor Dal Export India" loading="lazy">
                    </div>
                    ...
                    <div class="benefits-wrapper" id="benefitsWrapper">
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Quick Cooking</h4>
                                <p>No soaking required. Cooks faster than most other lentils, saving time and energy.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                ...
                                <p>Processed through optical sorters to ensure 99.5% purity and uniform crimson color.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>High Protein</h4>
                                <p>An excellent source of plant-based protein, iron, and dietary fiber.</p>
                            </div>
                        </div>
                        ...
                        <div class="benefit-item">
                            ...
                            <div class="benefit-box">
                                <h4>Vibrant Color</h4>
                                <p>Available in deep orange-red (unpolished) or shiny red (oil polished) varieties.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp-content">
                    ...
                    <div class="intro-text">
                        AGROX exports premium Red Lentils (Masoor Dal), prized globally for their vibrant red color and nutty flavor. Unlike other pulses, Masoor Dal cooks quickly and disintegrates easily, making it perfect for thickening soups, stews, and curries. We source the finest crops from Indian farms and process them in hygienic facilities to deliver football-type (whole) and split varieties.
                    </div>

                    <div class="section-title" style="margin-top: 0;">Product Varieties</div>
                    <div class="grid-2-col">
                        <div class="variety-card">
                            <h4>Red Split Lentils</h4>
                            <ul>
                                <li><strong>Type:</strong> Skin removed, split.</li>
                                <li><strong>Appearance:</strong> Bright Orange/Red.</li>
                                <li><strong>Use:</strong> Dals, Soups, Purees.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Football Red (Whole)</h4>
                            <ul>
                                <li><strong>Type:</strong> Skin removed, whole grain.</li>
                                <li><strong>Shape:</strong> Round "Football" shape.</li>
                                <li><strong>Use:</strong> Premium dishes, Salads.</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Whole Masoor (Brown)</h4>
                            <ul>
                                <li><strong>Type:</strong> Whole grain with skin.</li>
                                <li><strong>Appearance:</strong> Brown/Grey exterior.</li>
                                <li><strong>Use:</strong> Sprouts, Stews (holds shape).</li>
                            </ul>
                        </div>
                        <div class="variety-card">
                            <h4>Polished vs Unpolished</h4>
                            <ul>
                                <li><strong>Oil Polished:</strong> Shiny, longer shelf life.</li>
                                <li><strong>Water Polished:</strong> Silky finish.</li>
                                <li><strong>Unpolished:</strong> 100% Natural matte finish.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <table class="spec-table">
                        <tr><th>Botanical Name</th><td>Lens culinaris</td></tr>
                        <tr><th>Purity</th><td>99% - 99.5% (Sortex Cleaned)</td></tr>
                        <tr><th>Moisture</th><td>12% Maximum</td></tr>
                        <tr><th>Admixture</th><td>0.5% Maximum</td></tr>
                        <tr><th>Foreign Matter</th><td>0.2% Maximum</td></tr>
                        <tr><th>Broken Grains</th><td>2% Maximum (for whole grades)</td></tr>
            ...
            <div class="full-width-content">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p><strong>Standard & Custom</strong><br>We offer 25kg and 50kg PP Woven bags. For retail chains, we provide 500g and 1kg consumer packs with private labeling.</p>
                    </div>
                    <div class="info-card">
                        <h4>Nutritional Value</h4>
                        <p><strong>Iron Rich</strong><br>Red lentils are one of the best vegan sources of iron and folate, making them highly sought after in health-conscious markets.</p>
                    </div>
                    <div class="info-card">
                        <h4>Shipping Capacity</h4>
                        <p><strong>20 FT Container:</strong> 24 Metric Tons<br><strong>Availability:</strong> Year-round<br><strong>Origin:</strong> India</p>
                    </div>
                </div>
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        <span class="faq-q">Q: What is "Football" Red Lentil?</span>
                        <span class="faq-a">"Football" refers to the whole red lentil grain where the skin is removed (decorticated) but the grain remains whole (not split), resembling a tiny football.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Can you supply oil-polished lentils?</span>
                        <span class="faq-a">Yes, we offer oil polishing using edible refined oil to give the lentils a shiny appearance and improved shelf stability.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: Do you offer small consumer packaging?</span>
                        <span class="faq-a">Yes, we have automated packing lines for 500g, 1kg, and 2kg pouches, which can be printed with your brand name.</span>
                    </div>
                    <div class="faq-item">
                        <span class="faq-q">Q: How do you ensure color consistency?</span>
                        <span class="faq-a">Our advanced Sortex machines detect and remove discolored or pale grains, ensuring a uniform bright orange/red color in the final bag.</span>
                    </div>
                </div>
...
<script type="application/ld+json">
{
  ...
  "image": "https://theagroxgroup.org/assets/images/redlentis.avif",
  "description": "Premium Red Lentils (Masoor Dal) Exporter from India. Available in Football (Whole Red) and Split Red varieties. Sortex cleaned and high protein.",
  "brand": { "@type": "Organization", "name": "AGROX Organic Exports" },
  "sku": "MASOOR-RED-EXP",
  "offers": {
    "@type": "Offer",
    "url": "https://theagroxgroup.org/products/red-lentils-masoor-dal-exporter-from-india.php",
    "priceCurrency": "USD",
